...
<head>
	...
	<script src="<?php echo $templater->fn('js_url', ['vendor/modernizr/modernizr.min.js']); ?>"></script>
</head>
<body>
<div class="p-pageWrapper">
	...
	<footer class="p-footer">
		...
		<div class="p-footer-copyright">
			<?php echo $templater->fn('copyright'); ?>
		</div>
	</footer>
</div>

<?php echo $templater->fn('core_js'); ?>
<!--XF:JS-->

<script>
	jQuery.extend(true, XF.config, {
		csrf: '<?php echo $templater->filter($templater->fn('csrf_token'), [['escape', ['js']]]); ?>'
	});
