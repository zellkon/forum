...
class MemberStat extends AbstractController
{
	...
	public function actionDelete(ParameterBag $params)
	{
		...
		if (!$memberStat->preDelete())
		{
			return $this->error($memberStat->getErrors());
		}

		if ($this->isPost())
		{
			$memberStat->delete();
			return $this->redirect($this->buildLink('member-stats'));
		}
		else
		{
			$viewParams = [
			...
			return $this->view('XF:MemberStat\Delete', 'member_stat_delete', $viewParams);
		}
	}
