...
class Moderator extends AbstractController
{
	...
	public function actionSuperDelete(ParameterBag $params)
	{
		...
		else
		{
			...
			return $this->view('XF:Moderator\SuperDelete', 'moderator_super_delete', $viewParams);
		}
	}
	...
	public function actionContentDelete(ParameterBag $params)
	{
		...
		else
		{
			...
			return $this->view('XF:Moderator\ContentDelete', 'moderator_content_delete', $viewParams);
		}
	}
