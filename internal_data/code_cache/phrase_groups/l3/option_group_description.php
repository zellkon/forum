...
You may set a user into \'discouraged\' mode by editing their user profile, or discourage an IP address or IP address range.',
  ...
  'option_group_description.newsfeed' => 'Nguồn cung cấp tin tức hoặc luồng hoạt động là nhật ký được cập nhật liên tục về những điều mà các thành viên đã đăng ký của bạn làm, có thể được xem lại bởi các khách truy cập khác..<br />
<br />
Có thể lọc nguồn cấp dữ liệu xuống chỉ cho những người dùng bạn theo dõi, hoặc một người dùng duy nhất.',
