...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Thành viên đã đăng ký');
...
' . $__templater->callMacro('metadata_macros', 'canonical_url', array(
		'canonicalUrl' => $__templater->fn('link', array('canonical:members/list', null, array('page' => $__vars['page'], ), ), false),
	), $__vars) . '
