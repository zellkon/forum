...
return array('macros' => array('moderator_menu_actions' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canViewWarnings', array()) AND ($__vars['user']['warning_count'] AND ($__vars['context'] == 'tooltip'))) {
		$__finalCompiled .= '
		<a href="' . $__templater->fn('link', array('members', $__vars['user'], ), true) . '#warnings" class="menu-linkRow">' . 'Xem cảnh báo (' . $__templater->filter($__vars['user']['warning_count'], array(array('number', array()),), true) . ')' . '</a>
	';
	}
	$__finalCompiled .= '
	';
	if ($__templater->method($__vars['xf']['visitor'], 'canViewIps', array())) {
		$__finalCompiled .= '
		<a href="' . $__templater->fn('link', array('members/user-ips', $__vars['user'], ), true) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Địa chỉ IP' . '</a>
		<a href="' . $__templater->fn('link', array('members/shared-ips', $__vars['user'], ), true) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Chia sẻ IPs' . '</a>
	';
	}
	$__finalCompiled .= '
	';
...
'member_stat_pairs' => function($__templater, array $__arguments, array $__vars)
{
	...
	' . '
	<dl class="pairs pairs--rows pairs--rows--centered">
		<dt title="' . $__templater->filter('Đã được thích', array(array('for_attr', array()),), true) . '">' . 'Thích' . '</dt>
		<dd>
