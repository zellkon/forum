...
return array('macros' => array('message' => function($__templater, array $__arguments, array $__vars)
{
				...
				<div class="message-main js-quickEditTarget">
					<div class="message-content">
						<header class="message-attribution">
							<a href="' . $__templater->fn('link', array('conversations/messages', $__vars['message'], ), true) . '" class="message-attribution-main u-concealed" rel="nofollow">
								' . $__templater->fn('date_dynamic', array($__vars['message']['message_date'], array(
	))) . '
							</a>
	...
	$__finalCompiled .= '
						...
						<div class="message-userContent lbContainer js-lbContainer"
							...
							data-lb-caption-desc="' . $__templater->fn('date_time', array($__vars['message']['message_date'], ), true) . '">

							<article class="message-body js-selectToQuote">
								' . $__templater->fn('bb_code', array($__vars['message']['message'], 'conversation_message', $__vars['message'], ), true) . '
	...
	if ($__templater->method($__vars['message'], 'canLike', array())) {
		$__compilerTemp2 .= '
													<a href="' . $__templater->fn('link', array('conversations/messages/like', $__vars['message'], ), true) . '" class="actionBar-action actionBar-action--like" data-xf-click="like" data-like-list="< .js-message | .js-likeList">';
		if ($__templater->method($__vars['message'], 'isLiked', array())) {
			$__compilerTemp2 .= 'Bỏ thích';
		} else {
			$__compilerTemp2 .= 'Thích';
		}
		$__compilerTemp2 .= '</a>
												';
	}
	...
	if ($__templater->method($__vars['conversation'], 'canReply', array())) {
		$__compilerTemp2 .= '
													';
		$__vars['quoteLink'] = $__templater->preEscaped($__templater->fn('link', array('conversations/reply', $__vars['conversation'], array('quote' => $__vars['message']['message_id'], ), ), true));
		$__compilerTemp2 .= '
													';
		...
		$__compilerTemp2 .= '
													<a href="' . $__templater->escape($__vars['quoteLink']) . '"
														...
														data-xf-click="quote"
														data-quote-href="' . $__templater->fn('link', array('conversations/messages/quote', $__vars['message'], ), true) . '">' . 'Trả lời' . '</a>
	...
	if ($__templater->method($__vars['message'], 'canReport', array())) {
		$__compilerTemp3 .= '
													<a href="' . $__templater->fn('link', array('conversations/messages/report', $__vars['message'], ), true) . '" class="actionBar-action actionBar-action--report" data-xf-click="overlay">' . 'Báo cáo' . '</a>
												';
	}
	$__compilerTemp3 .= '
	...
	if ($__templater->method($__vars['message'], 'canEdit', array())) {
		...
		$__compilerTemp3 .= '
													<a href="' . $__templater->fn('link', array('conversations/messages/edit', $__vars['message'], ), true) . '"
														class="actionBar-action actionBar-action--edit"
														data-xf-click="quick-edit"
														data-editor-target="< .js-quickEditTarget">' . 'Sửa' . '</a>
												';
	}
	$__compilerTemp3 .= '
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canViewIps', array()) AND $__vars['message']['ip_id']) {
		$__compilerTemp3 .= '
													<a href="' . $__templater->fn('link', array('conversations/messages/ip', $__vars['message'], ), true) . '"
	...
	$__finalCompiled .= '
						...
						<div class="likesBar js-likeList ' . ($__vars['message']['likes'] ? 'is-active' : '') . '">
							' . $__templater->fn('likes_content', array($__vars['message'], $__templater->fn('link', array('conversations/messages/likes', $__vars['message'], ), false), array(
		'url' => $__templater->fn('link', array('conversations/messages/likes', $__vars['message'], ), false),
	))) . '
						</div>
					</footer>
				</div>
