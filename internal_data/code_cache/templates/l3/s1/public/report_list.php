...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Mục đã được báo cáo nội dung xấu');
	$__finalCompiled .= '
...
<div class="block">
	...
	<div class="block-container">
		<h2 class="block-tabHeader tabs">
			<a href="' . $__templater->fn('link', array('reports', ), true) . '" class="tabs-tab is-active">' . 'Báo cáo chưa duyệt' . '</a>
			<a href="' . $__templater->fn('link', array('reports/closed', ), true) . '" class="tabs-tab">' . 'Báo cáo đã đóng' . '</a>
		</h2>
