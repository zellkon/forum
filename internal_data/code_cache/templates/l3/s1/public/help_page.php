...
' . $__templater->callMacro('metadata_macros', 'canonical_url', array(
		'canonicalUrl' => $__templater->fn('link', array('canonical:help', $__vars['page'], ), false),
	), $__vars) . '

';
	$__templater->breadcrumb($__templater->preEscaped('Trợ giúp'), $__templater->fn('link', array('help', ), false), array(
	));
	$__finalCompiled .= '
