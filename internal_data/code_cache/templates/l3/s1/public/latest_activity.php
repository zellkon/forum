...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Hoạt động mới nhất');
	$__finalCompiled .= '
		...
		$__finalCompiled .= '
			...
			<div class="block-footer js-newsFeedLoadMore">
				<span class="block-footer-controls">' . $__templater->button('
					' . 'Hiển thị mục cũ hơn' . '
				', array(
			'href' => $__templater->fn('link', array('whats-new/latest-activity', null, array('before_id' => $__vars['oldestItemId'], ), ), false),
			'rel' => 'nofollow',
