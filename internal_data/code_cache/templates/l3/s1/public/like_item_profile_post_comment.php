...
return array('macros' => array('like_snippet' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['comment']['user_id'] == $__vars['xf']['visitor']['user_id']) {
		...
		$__finalCompiled .= '
			' . '' . $__templater->fn('username_link', array($__vars['liker'], false, array('defaultname' => $__vars['fallbackName'], ), ), true) . ' thích <a ' . (('href="' . $__templater->fn('link', array('profile-posts/comments', $__vars['comment'], ), true)) . '"') . '>' . $__templater->escape($__vars['comment']['username']) . '\'s bình luận</a> trong bài gửi trên hồ sơ.' . '
		';
	} else {
		$__finalCompiled .= '
