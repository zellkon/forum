...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if ($__templater->isTraversable($__vars['memberStats'])) {
		foreach ($__vars['memberStats'] AS $__vars['key'] => $__vars['memberStat']) {
			$__compilerTemp1 .= '
					<a class="blockLink ' . (($__vars['pageSelected'] == $__vars['key']) ? 'is-selected' : '') . '" href="' . $__templater->fn('link', array('members', null, array('key' => $__vars['memberStat']['member_stat_key'], ), ), true) . '">' . $__templater->escape($__vars['memberStat']['title']) . '</a>
				';
		}
	}
	$__compilerTemp2 = '';
	if ($__vars['xf']['options']['enableMemberList']) {
		$__compilerTemp2 .= '
					<a class="blockLink ' . (($__vars['pageSelected'] == 'member_list') ? 'is-selected' : '') . '" href="' . $__templater->fn('link', array('members/list', ), true) . '">' . 'Thành viên đã đăng ký' . '</a>
				';
	}
	...
	<div class="block">
		<div class="block-container">
			...
			<div class="block-body">
				<a class="blockLink ' . (($__vars['pageSelected'] == 'overview') ? 'is-selected' : '') . '" href="' . $__templater->fn('link', array('members', ), true) . '">' . 'Tổng quan' . '</a>
				' . $__compilerTemp1 . '
				' . $__compilerTemp2 . '
			</div>
		</div>
