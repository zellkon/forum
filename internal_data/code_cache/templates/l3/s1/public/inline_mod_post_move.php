...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Inline Moderation - Move Posts');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body js-prefixListenContainer">
			' . $__templater->formInfoRow('Are you sure you want to move ' . $__templater->escape($__vars['total']) . ' post(s) to a new thread?', array(
		'rowtype' => 'confirm',
	)) . '
...
' . $__vars['xf']['language']['label_separator'] . '</label>
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['first']['Thread'], 'title', ), false),
	)) . '
					'),
		'_type' => 'option',
	),
