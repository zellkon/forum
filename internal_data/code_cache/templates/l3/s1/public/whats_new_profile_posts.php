...
<div class="block" data-xf-init="' . ($__vars['canInlineMod'] ? 'inline-mod' : '') . '" data-type="profile_post" data-href="' . $__templater->fn('link', array('inline-mod', ), true) . '">
	';
	...
	if ($__vars['xf']['visitor']['user_id']) {
		...
		$__finalCompiled .= '
			...
			'_type' => 'option',
							...
							', array(
			'action' => $__templater->fn('link', array('whats-new/profile-posts', ), false),
		)) . '
						</div>
					</div>
				</div>
