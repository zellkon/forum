...
';
		...
		$__finalCompiled .= '
	' . 'Your profile post on ' . (((('<a href="' . $__templater->fn('base_url', array($__vars['extra']['link'], ), true)) . '" class="fauxBlockLink-blockLink">') . $__templater->escape($__vars['extra']['profileUser'])) . '</a>') . '\'s profile was edited.' . '
';
	}
	$__finalCompiled .= '
';
