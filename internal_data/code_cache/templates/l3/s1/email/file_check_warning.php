...
<p>' . 'An automatic file health check was started on ' . $__templater->escape($__vars['xf']['options']['boardTitle']) . ' at ' . $__templater->fn('date_time', array($__vars['fileCheck']['check_date'], ), true) . ' and some problems were found that should be resolved as soon as possible.' . '</p>
...
<table cellpadding="10" cellspacing="0" border="0" width="100%" class="linkBar">
	<tr>
		<td>
			<a href="' . $__templater->fn('link_type', array('admin', 'canonical:tools/file-check/results', $__vars['fileCheck'], ), true) . '" class="button">' . 'Please review the files' . '</a>
		</td>
	</tr>
</table>';
