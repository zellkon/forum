	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('
				...
				<strong><a href="' . $__templater->fn('link', array('connected-accounts/edit', $__vars['provider'], ), true) . '">' . $__templater->escape($__vars['provider']['title']) . '</a></strong>
			', array(
		'rowtype' => 'confirm',
	)) . '
		</div>
...
', array(
		'action' => $__templater->fn('link', array('connected-accounts/deactivate', $__vars['provider'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
