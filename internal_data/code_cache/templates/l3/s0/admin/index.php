...
';
	...
	<div class="block">
		<div class="block-container">
			<h2 class="block-header"><a href="' . $__templater->fn('link', array('stats', ), true) . '">' . 'Số liệu thống kê' . '</a></h2>
...
';
	...
	<div class="block">
		<div class="block-container">
			<h2 class="block-header">' . 'Hoạt động đăng nhập' . '</h2>
			<div class="block-body">
...
';
	...
	<div class="block">
		<div class="block-container">
			<h2 class="block-header">' . 'BQT trực tuyến' . '</h2>
			<ul class="block-body">
				';
