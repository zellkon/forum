<?php
// FROM HASH: af2ceea17fa99e2f3805c8142e01a206
...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->fn('link', array('feeds/delete', $__vars['feed'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
';
	...
	if ($__vars['feed']['feed_id']) {
		$__compilerTemp1 .= '
			...
			'maxlength' => $__templater->fn('max_length', array($__vars['feed'], 'title', ), false),
		), array(
			'label' => 'Tiêu đề',
		)) . '
			';
	...
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['feed'], 'url', ), false),
		'type' => 'url',
		'dir' => 'ltr',
	), array(
		'label' => 'URL',
...
',
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['feed'], 'title_template', ), false),
...
', array(
		'action' => $__templater->fn('link', array('feeds/save', $__vars['feed'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
