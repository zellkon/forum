	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('
				...
				<strong><a href="' . $__templater->fn('link', array('forums/edit', $__vars['node'], ), true) . '">' . $__templater->escape($__vars['node']['title']) . '</a></strong>
			', array(
		'rowtype' => 'confirm',
	)) . '
...
', array(
		'action' => $__templater->fn('link', array('forums/delete', $__vars['node'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
