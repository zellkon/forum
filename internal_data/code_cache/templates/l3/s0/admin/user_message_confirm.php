	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formRow('
				...
				<a href="' . $__templater->fn('link', array('users/list', null, array('criteria' => $__vars['criteria'], ), ), true) . '">' . 'View full list' . '</a>
			', array(
...
', array(
		'action' => $__templater->fn('link', array('users/message/send', ), false),
		'class' => 'block',
		'preview' => $__templater->fn('link', array('users/message/preview', ), false),
	));
