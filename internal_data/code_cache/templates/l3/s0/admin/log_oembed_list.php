...
', array(
		'action' => $__templater->fn('link', array('logs/oembed', ), false),
		'class' => 'block',
	)) . '
		...
		if ($__templater->isTraversable($__vars['entries'])) {
			foreach ($__vars['entries'] AS $__vars['entry']) {
				$__compilerTemp2 .= '
					...
					'href' => $__templater->fn('link', array('logs/oembed', $__vars['entry'], ), false),
					'overlay' => 'true',
					'overlaycache' => 'false',
					'_type' => 'cell',
					'html' => '
				...
				array(
					'href' => $__templater->fn('link', array('logs/oembed-item', $__vars['entry'], ), false),
