...
' . $__templater->form('
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['extension'], 'from_class', ), false),
		'dir' => 'ltr',
	), array(
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['extension'], 'to_class', ), false),
		'dir' => 'ltr',
	), array(
...
', array(
		'action' => $__templater->fn('link', array('class-extensions/save', $__vars['extension'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
