...
';
	...
	if ($__vars['isDemotion']) {
		...
		$__compilerTemp1 .= '
			<div class="block-body">
				' . $__templater->formInfoRow('
					' . 'Please confirm that you want to enable this promotion for the selected user' . $__vars['xf']['language']['label_separator'] . '
					<strong>' . $__templater->escape($__vars['user']['username']) . ' - ' . $__templater->escape($__vars['promotion']['title']) . '</strong>
...
', array(
		'action' => $__templater->fn('link', array('user-group-promotions/demote', null, array('promotion_id' => $__vars['promotion']['promotion_id'], 'user_id' => $__vars['promotionLog']['user_id'], ), ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
