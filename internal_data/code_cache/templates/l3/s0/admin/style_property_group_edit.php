...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->fn('link', array('style-properties/groups/delete', $__vars['group'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
';
	...
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['group'], 'group_name', ), false),
		'dir' => 'ltr',
	), array(
		'label' => 'Group Name',
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['group'], 'title', ), false),
	), array(
		'label' => 'Tiêu đề',
	)) . '
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['group'], 'description', ), false),
	), array(
		'label' => 'Mô tả',
	)) . '
...
', array(
		'action' => $__templater->fn('link', array('style-properties/groups/save', $__vars['group'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
