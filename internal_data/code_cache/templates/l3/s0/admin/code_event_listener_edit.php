...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->fn('link', array('code-events/listeners/delete', $__vars['listener'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
';
	...
	<div class="block-container">
		...
		'data-desc-url' => $__templater->fn('link', array('code-events/get-description', ), false),
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['listener'], 'hint', ), false),
		'dir' => 'ltr',
	), array(
		'label' => 'Event Hint',
		'explain' => 'Certain events take hints that can limit when the listener is run. This can result in performance improvements by loading the listener class in fewer cases. Individual events will list the value of the hint that will be passed in, if any.',
	)) . '
...
', array(
		'action' => $__templater->fn('link', array('code-events/listeners/save', $__vars['listener'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
