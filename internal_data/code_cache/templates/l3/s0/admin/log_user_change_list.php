...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Nhật ký thay đổi thành viên');
	$__finalCompiled .= '
...
', array(
		'action' => $__templater->fn('link', array('logs/user-change', ), false),
		'class' => 'block',
	)) . '
	...
	<div class="block">
		<div class="block-container">
			...
			<div class="block-footer">
				<span class="block-footer-counter">' . $__templater->fn('display_totals', array($__vars['totalChanges'], $__vars['total'], ), true) . '</span>
			</div>
		</div>
