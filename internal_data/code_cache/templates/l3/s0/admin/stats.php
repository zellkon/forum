...
<div class="block">
	...
	$__finalCompiled .= '
			<div class="block-desc">' . $__templater->fn('date', array($__vars['start'], 'absolute', ), true) . ' - ' . $__templater->fn('date', array($__vars['end'], 'absolute', ), true) . '</div>
		</h2>
...
';
	...
	$__compilerTemp7 = $__templater->fn('array_keys', array($__vars['statsTypeOptions'], ), false);
	...
	<div class="block-container">
		...
		'name' => 'start',
		'value' => $__templater->fn('date', array($__vars['start'], 'Y-m-d', ), false),
	)) . '
					<span class="inputGroup-text">-</span>
					' . $__templater->formDateInput(array(
		'name' => 'end',
		'value' => ($__vars['endDisplay'] ? $__templater->fn('date', array($__vars['endDisplay'], 'Y-m-d', ), false) : ''),
	)) . '
...
', array(
		'action' => $__templater->fn('link', array('stats', ), false),
		'class' => 'block',
	)) . '
