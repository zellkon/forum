...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->fn('link', array('admin-permissions/delete', $__vars['permission'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
' . $__templater->form('
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['permission'], 'admin_permission_id', ), false),
		'dir' => 'ltr',
	), array(
		'label' => 'Permission ID',
	)) . '
...
', array(
		'action' => $__templater->fn('link', array('admin-permissions/save', $__vars['permission'], ), false),
		'class' => 'block',
		'ajax' => 'true',
	));
