...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->fn('link', array('style-properties/delete', $__vars['property'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
';
	...
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['property'], 'property_name', ), false),
		'dir' => 'ltr',
	), array(
		'label' => 'Property Name',
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['property'], 'title', ), false),
	), array(
		'label' => 'Tiêu đề',
	)) . '
		...
		'autosize' => 'true',
		'maxlength' => $__templater->fn('max_length', array($__vars['property'], 'description', ), false),
	), array(
		'label' => 'Mô tả',
	)) . '
	...
	array(
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['property'], 'depends_on', ), false),
		'dir' => 'ltr',
	), array(
		'label' => 'Depends on',
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['property'], 'value_group', ), false),
		'dir' => 'ltr',
	), array(
...
', array(
		'action' => $__templater->fn('link', array('style-properties//save', $__vars['property'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
