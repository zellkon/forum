...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->fn('link', array('advertising/positions/delete', $__vars['advertisingPosition'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
';
	...
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['advertisingPosition'], 'position_id', ), false),
		'dir' => 'ltr',
	), array(
		'label' => 'Position ID',
	)) . '
...
', array(
		'action' => $__templater->fn('link', array('advertising/positions/save', $__vars['advertisingPosition'], ), false),
		'class' => 'block',
		'ajax' => 'true',
	));
