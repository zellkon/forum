...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->fn('link', array('widgets/definitions/delete', $__vars['widgetDefinition'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
' . $__templater->form('
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['widgetDefinition'], 'definition_id', ), false),
		'dir' => 'ltr',
	), array(
		'label' => 'Definition ID',
	)) . '
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['widgetDefinition'], 'definition_class', ), false),
		'dir' => 'ltr',
	), array(
...
', array(
		'action' => $__templater->fn('link', array('widgets/definitions/save', $__vars['widgetDefinition'], ), false),
		'class' => 'block',
		'ajax' => 'true',
	));
