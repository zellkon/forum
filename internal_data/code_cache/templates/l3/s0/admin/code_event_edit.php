...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->fn('link', array('code-events/delete', $__vars['event'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
' . $__templater->form('
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['event'], 'event_id', ), false),
		'dir' => 'ltr',
	), array(
		'label' => 'Event ID',
	)) . '
...
', array(
		'action' => $__templater->fn('link', array('code-events/save', $__vars['event'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
