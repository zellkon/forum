	...
	<div class="block"' . $__templater->fn('widget_data', array($__vars['widget'], ), true) . '>
		...
		if ($__vars['style'] == 'full') {
			...
			if (!$__templater->test($__vars['threads'], 'empty', array())) {
				...
				$__finalCompiled .= '
							<div class="block-row">
								' . 'Bạn không có bài viết chưa đọc. Bạn có thể <a href="' . $__templater->fn('link', array('whats-new/posts', null, array('skip' => 1, ), ), true) . '" rel="nofollow">xem tất cả các bài viết mới nhất</a> thay thế.' . '
							</div>
						';
			} else {
				$__finalCompiled .= '
