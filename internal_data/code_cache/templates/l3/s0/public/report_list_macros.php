...
return array('macros' => array('item' => function($__templater, array $__arguments, array $__vars)
{
	...
	<div class="structItem structItem--report ' . (($__templater->method($__vars['report'], 'canView', array($__vars['report'], )) AND $__templater->method($__vars['report'], 'isAssignedTo', array())) ? 'is-highlighted' : '') . '">
		<div class="structItem-cell structItem-cell--icon">
			<div class="structItem-iconContainer">
				' . $__templater->fn('avatar', array($__vars['report']['User'], 's', false, array(
	))) . '
			</div>
		</div>
		<div class="structItem-cell structItem-cell--main" data-xf-init="touch-proxy">
			<a href="' . $__templater->fn('link', array('reports', $__vars['report'], ), true) . '" class="structItem-title" data-tp-primary="on">
				';
	...
	$__finalCompiled .= '
				...
				<ul class="structItem-parts">
					<li>' . $__templater->fn('username_link', array($__vars['report']['User'], false, array(
		'defaultname' => 'Unknown Member',
	))) . '</li>
					<li class="structItem-startDate"><a href="' . $__templater->fn('link', array('reports', $__vars['report'], ), true) . '" rel="nofollow">' . $__templater->fn('date_dynamic', array($__vars['report']['first_report_date'], array(
	))) . '</a></li>
				</ul>
			</div>
		</div>
		...
		<div class="structItem-cell structItem-cell--latest">
			<a href="' . $__templater->fn('link', array('reports', $__vars['report'], ), true) . '" rel="nofollow">' . $__templater->fn('date_dynamic', array($__vars['report']['last_modified_date'], array(
	...
	if ($__templater->method($__vars['report'], 'canView', array($__vars['report'], ))) {
		$__finalCompiled .= '
					' . $__templater->fn('username_link', array($__vars['report']['last_modified_cache'], false, array(
		))) . '
				';
	} else {
		$__finalCompiled .= '
...
'search_menu' => function($__templater, array $__arguments, array $__vars)
{
	...
	<div class="menu" data-menu="menu" aria-hidden="true">
		...
		', array(
		'action' => $__templater->fn('link', array('reports/search', ), false),
		'class' => 'menu-content',
	)) . '
	</div>
';
