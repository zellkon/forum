...
<div class="block">
	...
	$__finalCompiled .= '
		<div class="block-footer block-footer--split">
			<span class="block-footer-counter">' . 'Tổng điểm' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->fn('number', array($__vars['user']['trophy_points'], ), true) . '</span>
			<span class="block-footer-controls">
				' . $__templater->button('
					' . 'Xem tất cả danh hiệu có sẵn' . '
				', array(
		'href' => $__templater->fn('link', array('help', array('page_name' => 'trophies', ), ), false),
	), '', array(
	)) . '
			</span>
		</div>
