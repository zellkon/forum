	...
	if ($__vars['attachment']['has_thumbnail']) {
		$__finalCompiled .= '
			...
			<div class="attachment-icon attachment-icon--img">
				<a href="' . $__templater->fn('link', array('attachments', $__vars['attachment'], ), true) . '" target="_blank" class="' . ($__vars['canView'] ? 'js-lbImage' : '') . '">
		...
		$__finalCompiled .= '
			<div class="attachment-icon" data-extension="' . $__templater->escape($__vars['attachment']['extension']) . '">
				<a href="' . $__templater->fn('link', array('attachments', $__vars['attachment'], ), true) . '" target="_blank"><i aria-hidden="true"></i></a>
			</div>
		';
	}
	$__finalCompiled .= '
		<div class="attachment-name">
			<a href="' . $__templater->fn('link', array('attachments', $__vars['attachment'], ), true) . '" target="_blank" title="' . $__templater->escape($__vars['attachment']['filename']) . '">' . $__templater->escape($__vars['attachment']['filename']) . '</a>
		</div>
		<div class="attachment-details">
			...
			<span class="attachment-details-views">' . 'Lượt xem' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->filter($__vars['attachment']['view_count'], array(array('number', array()),), true) . '</span>
		</div>
	</li>
';
