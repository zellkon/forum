...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Di chuyển chủ đề' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->fn('prefix', array('thread', $__vars['thread'], 'escaped', ), true) . $__templater->escape($__vars['thread']['title']));
	$__finalCompiled .= '
';
	$__templater->pageParams['pageH1'] = $__templater->preEscaped('Di chuyển chủ đề' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->fn('prefix', array('thread', $__vars['thread'], ), true) . $__templater->escape($__vars['thread']['title']));
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		...
		'href' => $__templater->fn('link', array('forums/prefixes', ), false),
...
',
		...
		'value' => '1',
		'selected' => true,
		'label' => 'Thông báo đến thành viên đang quan tâm diễn đàn chuyển đến.',
		'_type' => 'option',
	)), array(
	)) . '
...
', array(
		'action' => $__templater->fn('link', array('threads/move', $__vars['thread'], ), false),
		'class' => 'block',
		'ajax' => 'true',
	));
