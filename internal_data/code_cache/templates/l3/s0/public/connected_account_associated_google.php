...
<div><a href="https://plus.google.com/u/0/' . $__templater->escape($__vars['connectedAccounts']['google']) . '" target="_blank">' . ($__templater->escape($__vars['providerData']['username']) ?: 'Tài khoản không xác định') . '</a></div>';
