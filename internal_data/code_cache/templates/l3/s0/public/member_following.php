...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Thành viên ' . $__templater->escape($__vars['user']['username']) . ' đang theo dõi');
	$__finalCompiled .= '
	...
	if ($__vars['hasMore']) {
		$__finalCompiled .= '
			<div class="block-footer">
				...
				', array(
			'href' => $__templater->fn('link', array('members/following', $__vars['user'], array('page' => $__vars['page'] + 1, ), ), false),
