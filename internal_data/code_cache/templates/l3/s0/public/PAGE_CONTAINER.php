...
';
	...
	if ($__vars['xf']['visitor']['is_moderator'] AND (!$__vars['xf']['options']['reportIntoForumId'])) {
		$__compilerTemp2 .= '
								<a href="' . $__templater->fn('link', array('reports', ), true) . '" class="menu-linkRow" title="' . ($__vars['xf']['session']['reportCounts']['lastBuilt'] ? (('Last Report Update' . $__vars['xf']['language']['label_separator'] . ' ') . $__templater->fn('date_time', array($__vars['xf']['session']['reportCounts']['lastBuilt'], ), true)) : '') . '">' . 'Báo cáo' . '</a>
							';
	}
	$__compilerTemp2 .= '
							' . '
			...
			$__compilerTemp4 .= '
				...
				'href' => '',
							...
							<a href="' . $__templater->fn('link', array('conversations', ), true) . '"
								...
								<span class="p-navgroup-linkText">' . 'Hộp thư' . '</span>
							</a>
							...
							<a href="' . $__templater->fn('link', array('account/alerts', ), true) . '"
								...
								aria-haspopup="true">
								<i aria-hidden="true"></i>
								<span class="p-navgroup-linkText">' . 'Thông báo' . '</span>
							</a>
							<div class="menu menu--structural menu--medium" data-menu="menu" aria-hidden="true"
			...
			'_type' => 'option',
								...
								<div class="menu-row">
									<div class="inputGroup">
										<span class="inputGroup-text">' . 'Bởi' . $__vars['xf']['language']['label_separator'] . '</span>
...
<footer class="p-footer" id="footer">
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canChangeStyle', array())) {
		$__compilerTemp11 .= '
							<li><a href="' . $__templater->fn('link', array('misc/style', ), true) . '" data-xf-click="overlay"
								...
								<i class="fa fa-paint-brush" aria-hidden="true"></i> ' . $__templater->escape($__vars['xf']['style']['title']) . '
							</a></li>
						';
	}
	$__compilerTemp11 .= '
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canChangeLanguage', array())) {
		$__compilerTemp11 .= '
							<li><a href="' . $__templater->fn('link', array('misc/language', ), true) . '" data-xf-click="overlay"
								...
								<i class="fa fa-globe" aria-hidden="true"></i> ' . $__templater->escape($__vars['xf']['language']['title']) . '</a></li>
						';
	}
	$__compilerTemp11 .= '
					';
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canUseContactForm', array())) {
		...
		if ($__vars['xf']['options']['contactUrl']['type'] == 'default') {
			$__finalCompiled .= '
							<li><a href="' . $__templater->fn('link', array('misc/contact', ), true) . '" data-xf-click="overlay">' . 'Liên hệ' . '</a></li>
						';
		} else if ($__vars['xf']['options']['contactUrl']['type'] == 'custom') {
			$__finalCompiled .= '
							<li><a href="' . $__templater->escape($__vars['xf']['options']['contactUrl']['custom']) . '" data-xf-click="' . ($__vars['xf']['options']['contactUrl']['overlay'] ? 'overlay' : '') . '">' . 'Liên hệ' . '</a></li>
						';
		}
		$__finalCompiled .= '
					';
	...
	if ($__vars['xf']['options']['privacyPolicyUrl']) {
		$__finalCompiled .= '
						<li><a href="' . $__templater->escape($__vars['xf']['options']['privacyPolicyUrl']) . '">' . 'Bảo mật cá nhân' . '</a></li>
					';
	}
	$__finalCompiled .= '
