...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped(($__vars['isUnread'] ? 'Đánh dấu là đã đọc' : 'Đánh dấu là chưa đọc'));
	$__finalCompiled .= '
	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('
				' . $__compilerTemp1 . '
				<strong><a href="' . $__templater->fn('link', array('conversations', $__vars['conversation'], ), true) . '">' . $__templater->escape($__vars['conversation']['title']) . '</a></strong>
			', array(
		'rowtype' => 'confirm',
	)) . '
		</div>
		' . $__templater->formSubmitRow(array(
		'submit' => ($__vars['isUnread'] ? 'Đánh dấu là đã đọc' : 'Đánh dấu là chưa đọc'),
	), array(
		'rowtype' => 'simple',
	)) . '
	</div>
...
', array(
		'action' => $__templater->fn('link', array('conversations/mark-unread', $__vars['userConv'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
