...
', array(
		'action' => $__templater->fn('link', array('conversations/messages/edit', $__vars['message'], ), false),
		'ajax' => 'true',
		'class' => 'block',
		'data-xf-init' => 'attachment-manager',
		'data-preview-url' => $__templater->fn('link', array('conversations/messages/preview', $__vars['message'], ), false),
	));
