	...
	if ($__vars['modTypes']) {
		...
		if ($__templater->isTraversable($__vars['modTypes'])) {
			foreach ($__vars['modTypes'] AS $__vars['type'] => $__vars['text']) {
				$__finalCompiled .= '
									<a href="' . $__templater->fn('link', array('tags', $__vars['tag'], array('mod' => $__vars['type'], 'page' => $__vars['page'], ), ), true) . '" class="menu-linkRow ' . (($__vars['activeModType'] == $__vars['type']) ? 'is-selected' : '') . '">' . $__templater->escape($__vars['text']) . '</a>
								';
			}
		}
		$__finalCompiled .= '
		...
		if ($__vars['activeModType']) {
			$__finalCompiled .= '
									...
									<a href="' . $__templater->fn('link', array('tags', $__vars['tag'], array('page' => $__vars['page'], ), ), true) . '" class="menu-linkRow">' . 'Vô hiệu hóa' . '</a>
								';
		}
		$__finalCompiled .= '
							</div>
