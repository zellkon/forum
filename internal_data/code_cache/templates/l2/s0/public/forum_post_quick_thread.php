...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	<div class="js-quickThreadFields" data-xf-init="attachment-manager">
		...
		'name' => 'more-options',
		'value' => '1',
		'title' => $__templater->filter('Hiển thị trình chỉnh sửa chủ đề mới đầy đủ với các tùy chọn đính kèm tệp, tạo phiếu thăm dò và hơn thế nữa', array(array('for_attr', array()),), false),
		...
		'title' => $__templater->filter('Hủy bỏ', array(array('for_attr', array()),), false),
		'data-xf-init' => 'tooltip',
	), '', array(
	)) . '
			</div>
