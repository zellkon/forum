		...
		if ($__vars['showTitle']) {
			$__finalCompiled .= '
				<h3 class="block-textHeader">
					<a href="' . $__templater->fn('link', array('members', null, array('key' => $__vars['memberStat']['member_stat_key'], ), ), true) . '"
		...
		if ($__vars['showFooter']) {
			$__finalCompiled .= '
				<div class="memberOverviewBlock-seeMore">
					<a href="' . $__templater->fn('link', array('members', null, array('key' => $__vars['memberStat']['member_stat_key'], ), ), true) . '">' . 'Xem thêm' . $__vars['xf']['language']['ellipsis'] . '</a>
				</div>
			';
		}
		$__finalCompiled .= '
...
'overview_row' => function($__templater, array $__arguments, array $__vars)
{
	...
	<div class="contentRow contentRow--alignMiddle">
		<div class="contentRow-figure">
			' . $__templater->fn('avatar', array($__vars['data']['user'], 'xs', false, array(
	))) . '
		</div>
	...
	$__finalCompiled .= '
			<h3 class="contentRow-title">' . $__templater->fn('username_link', array($__vars['data']['user'], true, array(
	))) . '</h3>
		</div>
	</div>
';
...
' . $__templater->callMacro('metadata_macros', 'canonical_url', array(
		'canonicalUrl' => $__templater->fn('link', array('canonical:members', ), false),
	), $__vars) . '
