<?php
// FROM HASH: 7d2671ef664698052fde92f1a793a628
...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->fn('link', array('template-modifications/delete', $__vars['modification'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
' . $__templater->form('
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['modification'], 'template', ), false),
		'readonly' => (!$__templater->method($__vars['modification'], 'canEdit', array())),
		'ac' => 'single',
		'data-acurl' => $__templater->fn('link', array('template-modifications/auto-complete', null, array('type' => $__vars['modification']['type'], ), ), false),
		'dir' => 'ltr',
	), array(
		'label' => 'Template',
	)) . '
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['modification'], 'modification_key', ), false),
		'readonly' => (!$__templater->method($__vars['modification'], 'canEdit', array())),
		'dir' => 'ltr',
	), array(
			...
			<div class="js-templateContentsContainer u-hidden u-hidden--transition">
				' . $__templater->formRow('
					...
					<pre class="templateModContents"
						...
						data-contents-url="' . $__templater->fn('link', array('template-modifications/contents', '', array('type' => $__vars['modification']['type'], ), ), true) . '"
					><!--
	...
	array(
		...
		'hint' => (($__vars['xf']['debug'] AND $__vars['modification']['addon_id']) ? 'The value of this field will not be changed when this add-on is upgraded.' : ''),
		'label' => '
...
', array(
		'action' => $__templater->fn('link', array('template-modifications/save', $__vars['modification'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	)) . '
