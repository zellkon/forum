...
';
	...
	' . $__templater->button('Cấm thành viên', array(
		'href' => $__templater->fn('link', array('banning/users/add', ), false),
		'icon' => 'add',
	), '', array(
	)) . '
');
	...
	<div class="block">
		...
		if ($__templater->isTraversable($__vars['userBans'])) {
			foreach ($__vars['userBans'] AS $__vars['userBan']) {
				$__compilerTemp1 .= '
					...
					'href' => $__templater->fn('link', array('banning/users', $__vars['userBan']['User'], ), false),
					'_type' => 'cell',
				...
				array(
					'href' => $__templater->fn('link', array('banning/users', $__vars['userBan']['User'], ), false),
					'_type' => 'cell',
					'html' => ($__vars['userBan']['end_date'] ? $__templater->fn('date', array($__vars['userBan']['end_date'], ), true) : 'Vĩnh viễn'),
				),
				array(
					'href' => $__templater->fn('link', array('banning/users', $__vars['userBan']['User'], ), false),
					'_type' => 'cell',
				...
				array(
					'href' => $__templater->fn('link', array('users/edit', $__vars['userBan']['User'], ), false),
					'_type' => 'action',
					'html' => 'Thành viên',
				),
				array(
					'href' => $__templater->fn('link', array('banning/users/lift', $__vars['userBan']['User'], ), false),
					'tooltip' => 'Bỏ cấm túc',
					'_type' => 'delete',
					'html' => '',
				))) . '
		...
		array(
			...
			<div class="block-footer">
				<span class="block-footer-counter">' . $__templater->fn('display_totals', array($__vars['userBans'], $__vars['total'], ), true) . '</span>
			</div>
		</div>
