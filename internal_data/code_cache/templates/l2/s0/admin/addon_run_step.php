...
<form action="' . $__templater->fn('link', array($__vars['actionRoute'], $__vars['addOn'], ), true) . '" method="post"
	class="blockMessage"
	data-xf-init="auto-submit">

	<div>
		' . $__templater->escape($__vars['actionText']) . '
		<strong>' . $__templater->escape($__vars['addOn']['title']) . ' ' . $__templater->escape($__vars['addOn']['version_string']) . $__templater->fn('repeat', array(' . ', $__vars['count'], ), true) . '</strong>
	</div>
