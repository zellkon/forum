	...
	if ($__templater->isTraversable($__vars['phrases'])) {
		...
		';
			$__compilerTemp1 = array(array(
				'href' => $__templater->fn('link', array('phrases/edit', $__vars['phrase'], array('language_id' => $__vars['language']['language_id'], ), ), false),
			...
			if ($__vars['phrase']['language_id'] == $__vars['language']['language_id']) {
				$__compilerTemp1[] = array(
					'href' => $__templater->fn('link', array('phrases/delete', $__vars['phrase'], ), false),
...
'search_menu' => function($__templater, array $__arguments, array $__vars)
{
	...
	<div class="block-filterBar">
		<div class="filterBar">
			<a class="filterBar-menuTrigger" data-xf-click="menu" role="button" tabindex="0" aria-expanded="false" aria-haspopup="true">' . 'Tinh chỉnh và dịch' . '</a>
			<div class="menu menu--wide" data-menu="menu" aria-hidden="true"
				data-href="' . $__templater->fn('link', array('phrases/refine-search', null, array('language_id' => $__vars['language']['language_id'], ) + $__vars['conditions'], ), true) . '"
				data-load-target=".js-filterMenuBody">
				<div class="menu-content">
					<h4 class="menu-header">' . 'Tinh chỉnh và dịch' . '</h4>
...
';
	...
	' . $__templater->button('
		' . 'Thêm cụm từ' . '
	', array(
		'href' => $__templater->fn('link', array('phrases/add', null, array('language_id' => $__vars['language']['language_id'], ), ), false),
		'icon' => 'add',
...
<div class="block">
	<div class="block-outer">
		...
		'key' => 'phrases',
		'ajax' => $__templater->fn('link', array('languages/phrases', $__vars['language'], $__vars['linkParams'], ), false),
	...
	$__finalCompiled .= $__templater->dataList('
		...
		<div class="block-footer">
			<span class="block-footer-counter">' . $__templater->fn('display_totals', array($__vars['phrases'], $__vars['total'], ), true) . '</span>
		</div>
	</div>
