...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped($__templater->escape($__vars['node']['title']) . ' - ' . $__templater->escape($__vars['user']['username']) . ' - ' . 'Phân quyền');
	$__finalCompiled .= '
...
', array(
		'action' => $__templater->fn('link', array('nodes/permissions/user', $__vars['node'], array('user_id' => $__vars['user']['user_id'], ), ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
