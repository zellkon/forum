...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->fn('link', array('route-filters/delete', $__vars['routeFilter'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
' . $__templater->form('
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['routeFilter'], 'find_route', ), false),
		'dir' => 'ltr',
	), array(
		'label' => 'Find Route',
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['routeFilter'], 'replace_route', ), false),
		'dir' => 'ltr',
	), array(
		'label' => 'Replace With',
...
', array(
		'action' => $__templater->fn('link', array('route-filters/save', $__vars['routeFilter'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
