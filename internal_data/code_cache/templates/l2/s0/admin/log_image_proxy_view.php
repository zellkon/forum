...
<div class="block">
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formRow('
				<div><img src="' . $__templater->fn('link', array('logs/image-proxy/image', $__vars['image'], ), true) . '" alt="" style="max-width: 100%; max-height: 300px; display: block; margin: auto" /></div>
		...
		'label' => 'Hits',
			...
			' . $__templater->formRow($__templater->fn('date_dynamic', array($__vars['image']['first_request_date'], array(
	))), array(
		'label' => 'First Requested',
	)) . '
			' . $__templater->formRow($__templater->fn('date_dynamic', array($__vars['image']['last_request_date'], array(
	))), array(
