...
'property_edit_value' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['definitionEditable']) {
		$__compilerTemp2 .= '
			<a href="' . $__templater->fn('link', array('style-properties/edit', $__vars['property'], ), true) . '">' . 'Sửa' . '</a>
		';
	}
	...
	';
		...
		';
		$__compilerTemp3 = $__templater->mergeChoiceOptions(array(), $__vars['valueOptions']);
...
'property_edit_css' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['definitionEditable']) {
		$__compilerTemp1 .= '
			...
			'href' => $__templater->fn('link', array('style-properties/edit', $__vars['property'], ), false),
