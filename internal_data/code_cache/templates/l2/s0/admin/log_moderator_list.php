...
', array(
		'action' => $__templater->fn('link', array('logs/moderator', ), false),
		'class' => 'block',
	)) . '
		...
		if ($__templater->isTraversable($__vars['entries'])) {
			foreach ($__vars['entries'] AS $__vars['entry']) {
				$__compilerTemp2 .= '
					...
					'html' => '
								<div>
									<a href="' . $__templater->fn('link', array('logs/moderator', $__vars['entry'], ), true) . '" data-xf-click="overlay">' . $__templater->escape($__vars['entry']['action_text']) . '</a>
