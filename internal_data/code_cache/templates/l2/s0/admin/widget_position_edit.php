...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->fn('link', array('widgets/positions/delete', $__vars['widgetPosition'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
' . $__templater->form('
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['widgetPosition'], 'position_id', ), false),
		'dir' => 'ltr',
	), array(
		'label' => 'Position ID',
	)) . '
...
', array(
		'action' => $__templater->fn('link', array('widgets/positions/save', $__vars['widgetPosition'], ), false),
		'class' => 'block',
		'ajax' => 'true',
	));
