...
';
	...
	if ($__vars['errors']) {
		...
		$__compilerTemp1 .= '
					' . 'Vui lòng xem lại các cảnh báo và xác nhận bạn muốn tiếp tục cài đặt tiện ích sau đây' . $__vars['xf']['language']['label_separator'] . '
				';
	} else {
		$__compilerTemp1 .= '
...
', array(
		'action' => $__templater->fn('link', array('add-ons/install', $__vars['addOn'], ), false),
		'class' => 'block',
	));
