	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('
				...
				<strong><a href="' . $__templater->fn('link', array($__vars['groupLinkPrefix'] . '/edit', $__vars['promptGroup'], ), true) . '" data-xf-click="overlay">' . $__templater->escape($__vars['promptGroup']['title']) . '</a></strong>
...
', array(
		'action' => $__templater->fn('link', array($__vars['groupLinkPrefix'] . '/delete', $__vars['promptGroup'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
