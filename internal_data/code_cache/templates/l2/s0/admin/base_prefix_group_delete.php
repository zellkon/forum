	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('
				...
				<strong><a href="' . $__templater->fn('link', array($__vars['groupLinkPrefix'] . '/edit', $__vars['prefixGroup'], ), true) . '" data-xf-click="overlay">' . $__templater->escape($__vars['prefixGroup']['title']) . '</a></strong>
...
', array(
		'action' => $__templater->fn('link', array($__vars['groupLinkPrefix'] . '/delete', $__vars['prefixGroup'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
