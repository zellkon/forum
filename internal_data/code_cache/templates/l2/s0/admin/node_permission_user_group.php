...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped($__templater->escape($__vars['node']['title']) . ' - ' . $__templater->escape($__vars['userGroup']['title']) . ' - ' . 'Phân quyền');
	$__finalCompiled .= '
...
', array(
		'action' => $__templater->fn('link', array('nodes/permissions/user-group', $__vars['node'], array('user_group_id' => $__vars['userGroup']['user_group_id'], ), ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
