...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->fn('link', array('permission-definitions/interface-groups/delete', $__vars['interfaceGroup'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
' . $__templater->form('
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['interfaceGroup'], 'interface_group_id', ), false),
		'dir' => 'ltr',
	), array(
...
', array(
		'action' => $__templater->fn('link', array('permission-definitions/interface-groups/save', $__vars['interfaceGroup'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
