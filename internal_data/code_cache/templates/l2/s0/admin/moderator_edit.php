...
';
	if (($__vars['contentModerator'] ? $__templater->method($__vars['contentModerator'], 'isUpdate', array()) : $__templater->method($__vars['generalModerator'], 'isUpdate', array()))) {
		...
		' . $__templater->button('', array(
				'href' => $__templater->fn('link', array('moderators/content/delete', $__vars['contentModerator'], ), false),
				'icon' => 'delete',
				'overlay' => 'true',
			), '', array(
			)) . '
	';
			...
			$__compilerTemp1 .= '
		' . $__templater->button('', array(
				'href' => $__templater->fn('link', array('moderators/super/delete', $__vars['generalModerator'], ), false),
				'icon' => 'delete',
				'overlay' => 'true',
			), '', array(
			)) . '
...
', array(
		'action' => $__templater->fn('link', array('moderators/save', ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
