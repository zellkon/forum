	...
	<div class="block-outer">
		...
		'aria-haspopup' => 'true',
				...
				<div class="menu menu--wide" data-menu="menu" aria-hidden="true"
					data-href="' . $__templater->fn('link', array('phrases/refine-search', null, array('language_id' => $__vars['language']['language_id'], 'translate_only' => true, ) + $__vars['conditions'], ), true) . '"
		...
		<div class="block js-phraseLoadMore">
			<div class="block-container">
				...
				<div class="block-footer block-footer--split">
					<span class="block-footer-counter">' . $__templater->fn('display_totals', array($__vars['count'], $__vars['total'], ), true) . '</span>
					';
		if ($__vars['hasMore']) {
			$__finalCompiled .= '
						<span class="block-footer-controls">' . $__templater->button('
							' . 'Thêm' . '
						', array(
				'href' => $__templater->fn('link', array('phrases/translation', null, array('last_title' => $__vars['last']['title'], 'last_count' => $__vars['count'], 'total' => $__vars['total'], 'language_id' => $__vars['language']['language_id'], ) + $__vars['conditions'], ), false),
