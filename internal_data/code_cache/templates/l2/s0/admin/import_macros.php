...
'step_smilies_config' => function($__templater, array $__arguments, array $__vars)
{
	...
	' . $__templater->formTextBoxRow(array(
		...
		'explain' => 'Smilies from the source system are not imported directly into XenForo, but rather all the available information is processed and placed into an XML file, which you can import using the <a href="' . $__templater->fn('link', array('smilies/import', ), true) . '" target="_blank">Import smilies</a> system later.<br />
<br />
