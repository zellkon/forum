...
';
	$__templater->breadcrumb($__templater->preEscaped('Phân quyền' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['record']['title'])), $__templater->fn('link', array('nodes/permissions', $__vars['record'], ), false), array(
	));
	$__finalCompiled .= '
