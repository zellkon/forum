...
';
	...
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['style'], 'title', ), false),
	), array(
		'label' => 'Tiêu đề',
	)) . '
		...
		'autosize' => 'true',
		'maxlength' => $__templater->fn('max_length', array($__vars['style'], 'description', ), false),
	), array(
		'label' => 'Mô tả',
	)) . '
...
', array(
		'action' => $__templater->fn('link', array('styles/save', $__vars['style'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
