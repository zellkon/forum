		...
		<div class="block-body">
			' . $__templater->formInfoRow('
				...
				<strong>
					...
					<a href="' . $__templater->fn('link', array('phrases/edit', $__vars['phrase'], ), true) . '">' . $__templater->escape($__vars['phrase']['title']) . '</a>
				</strong>
			', array(
		'rowtype' => 'confirm',
	)) . '
...
', array(
		'action' => $__templater->fn('link', array('phrases/delete', $__vars['phrase'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
