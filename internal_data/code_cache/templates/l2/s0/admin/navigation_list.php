...
'navigation_list_entry' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['depth'] == 1) {
		...
		if ($__vars['navigation']['navigation_id'] == $__vars['xf']['app']['defaultNavigationId']) {
			...
			$__compilerTemp1[] = array(
				'href' => $__templater->fn('link', array('navigation/edit', $__vars['navigation'], ), false),
			...
			$__compilerTemp1[] = array(
				'href' => ($__templater->method($__vars['navigation'], 'canDelete', array()) ? $__templater->fn('link', array('navigation/delete', $__vars['navigation'], ), false) : ''),
				'_type' => 'delete',
				'html' => '',
			);
		}
...
';
	...
	<div class="buttonGroup">
		...
		'href' => $__templater->fn('link', array('navigation/add', ), false),
		'icon' => 'add',
	), '', array(
	)) . '
		' . $__templater->button('', array(
		'href' => $__templater->fn('link', array('navigation/sort', ), false),
		'icon' => 'sort',
		'overlay' => 'true',
	), '', array(
	)) . '
...
' . $__templater->form('
	...
	<div class="block-container">
		...
		<div class="block-footer">
			<span class="block-footer-counter">' . $__templater->fn('display_totals', array($__templater->method($__vars['tree'], 'getFlattened', array(0, )), ), true) . '</span>
		</div>
	</div>
', array(
		'action' => $__templater->fn('link', array('navigation/toggle', ), false),
		'class' => 'block',
		'ajax' => 'true',
	)) . '
