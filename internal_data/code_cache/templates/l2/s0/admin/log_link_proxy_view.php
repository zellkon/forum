...
<div class="block">
	<div class="block-container">
		...
		'label' => 'Hits',
			...
			' . $__templater->formRow($__templater->fn('date_dynamic', array($__vars['link']['first_request_date'], array(
	))), array(
		'label' => 'First Requested',
	)) . '
			' . $__templater->formRow($__templater->fn('date_dynamic', array($__vars['link']['last_request_date'], array(
	))), array(
