...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->fn('link', array('permission-definitions/permissions/delete', $__vars['permission'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
';
	...
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['permission'], 'permission_group_id', ), false),
		'dir' => 'ltr',
	), array(
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['permission'], 'permission_id', ), false),
		'dir' => 'ltr',
	), array(
		'label' => 'Permission ID',
	)) . '
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['permission'], 'depend_permission_id', ), false),
	), array(
...
', array(
		'action' => $__templater->fn('link', array('permission-definitions/permissions/save', $__vars['permission'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
