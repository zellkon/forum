...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->fn('link', array('languages/delete', $__vars['language'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
';
	...
	$__compilerTemp4[] = array(
		...
		'size' => '15',
		'maxlength' => $__templater->fn('max_length', array($__vars['language'], 'date_format', ), false),
		'dir' => 'ltr',
	)) . '
						<p class="formRow-explain">' . 'Use PHP <a href="http://php.net/manual/en/function.date.php" target="_blank">date format</a>' . '</p>
					'),
		'_type' => 'option',
	);
	...
	$__compilerTemp5[] = array(
		...
		'size' => '15',
		'maxlength' => $__templater->fn('max_length', array($__vars['language'], 'time_format', ), false),
		'dir' => 'ltr',
	)) . '
						<p class="formRow-explain">' . 'Use PHP <a href="http://php.net/manual/en/function.date.php" target="_blank">time format</a>' . '</p>
					'),
		'_type' => 'option',
	);
	...
	$__compilerTemp6[] = array(
		...
		'size' => '15',
		'maxlength' => $__templater->fn('max_length', array($__vars['language'], 'currency_format', ), false),
	)) . '
						<p class="formRow-explain">' . 'Use PHP <a href="http://php.net/manual/en/function.money-format.php" target="_blank">money format</a>' . '</p>
					'),
		'_type' => 'option',
	);
	$__compilerTemp7 = '';
	...
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['language'], 'title', ), false),
	), array(
		'label' => 'Tiêu đề',
	)) . '
	...
	array(
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['language'], 'decimal_point', ), false),
	), array(
		...
		'size' => '5',
		'class' => 'input--autoSize',
		'maxlength' => $__templater->fn('max_length', array($__vars['language'], 'thousands_separator', ), false),
	), array(
		...
		'size' => '5',
		'class' => 'input--autoSize',
		'maxlength' => $__templater->fn('max_length', array($__vars['language'], 'label_separator', ), false),
	), array(
		...
		'size' => '5',
		'class' => 'input--autoSize',
		'maxlength' => $__templater->fn('max_length', array($__vars['language'], 'comma_separator', ), false),
	), array(
		...
		'size' => '5',
		'class' => 'input--autoSize',
		'maxlength' => $__templater->fn('max_length', array($__vars['language'], 'ellipsis', ), false),
	), array(
		...
		'size' => '5',
		'class' => 'input--autoSize',
		'maxlength' => $__templater->fn('max_length', array($__vars['language'], 'parenthesis_open', ), false),
	)) . '
		...
		'size' => '5',
		'class' => 'input--autoSize',
		'maxlength' => $__templater->fn('max_length', array($__vars['language'], 'parenthesis_close', ), false),
	)) . '
				</div>
			', array(
...
', array(
		'action' => $__templater->fn('link', array('languages/save', $__vars['language'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
