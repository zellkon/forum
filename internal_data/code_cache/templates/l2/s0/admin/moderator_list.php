...
';
	...
	' . $__templater->button('Thêm Kiểm duyệt viên', array(
		'href' => $__templater->fn('link', array('moderators/add', ), false),
		'icon' => 'add',
	), '', array(
	)) . '
');
			...
			if ($__templater->isTraversable($__vars['superModerators'])) {
				foreach ($__vars['superModerators'] AS $__vars['superMod']) {
					$__compilerTemp1 .= '
						...
						'href' => $__templater->fn('link', array('moderators/super/edit', $__vars['superMod'], ), false),
						'_type' => 'cell',
						'html' => '
									' . $__templater->fn('avatar', array($__vars['superMod']['User'], 's', false, array(
						'href' => '',
					))) . '
								',
					),
					...
					array(
						'href' => $__templater->fn('link', array('users/edit', $__vars['superMod']['User'], ), false),
						'_type' => 'action',
						'html' => 'Thông tin thành viên',
					),
					array(
						'href' => $__templater->fn('link', array('moderators/super/delete', $__vars['superMod'], ), false),
						'overlay' => 'true',
						'_type' => 'delete',
						'html' => '',
					))) . '
					...
					if ($__vars['contentModerators'][$__vars['userId']]) {
						...
						if ($__templater->isTraversable($__vars['contentModerators'][$__vars['userId']])) {
							foreach ($__vars['contentModerators'][$__vars['userId']] AS $__vars['contentMod']) {
								...
								array(
									'href' => $__templater->fn('link', array('moderators/content/edit', $__vars['contentMod'], ), false),
									'label' => $__templater->escape($__templater->method($__vars['contentMod'], 'getContentTitle', array())),
									'_type' => 'main',
									'html' => '',
								),
								array(
									'href' => $__templater->fn('link', array('moderators/content/delete', $__vars['contentMod'], ), false),
									'overlay' => 'true',
									'_type' => 'delete',
									'html' => '',
								))) . '
