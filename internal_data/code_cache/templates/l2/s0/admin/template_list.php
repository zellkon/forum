	...
	if ($__templater->isTraversable($__vars['templates'])) {
		...
		';
			$__compilerTemp1 = array(array(
				'href' => $__templater->fn('link', array('templates/edit', $__vars['template'], array('style_id' => $__vars['style']['style_id'], ), ), false),
			...
			if ($__vars['template']['style_id'] == $__vars['style']['style_id']) {
				$__compilerTemp1[] = array(
					'href' => $__templater->fn('link', array('templates/delete', $__vars['template'], ), false),
...
'search_menu' => function($__templater, array $__arguments, array $__vars)
{
	...
	<div class="block-filterBar">
		<div class="filterBar">
			<a class="filterBar-menuTrigger" data-xf-click="menu" role="button" tabindex="0" aria-expanded="false" aria-haspopup="true">' . 'Tinh chỉnh tìm kiếm' . '</a>
			<div class="menu menu--wide" data-menu="menu" aria-hidden="true"
				data-href="' . $__templater->fn('link', array('templates/refine-search', null, array('style_id' => $__vars['style']['style_id'], ) + $__vars['conditions'], ), true) . '"
...
';
	...
	' . $__templater->button('
		' . 'Thêm mẫu' . '
	', array(
		'href' => $__templater->fn('link', array('templates/add', null, array('style_id' => $__vars['style']['style_id'], 'type' => $__vars['type'], ), ), false),
		'icon' => 'add',
...
<div class="block">
	<div class="block-outer">
		...
		'key' => 'templates',
		'ajax' => $__templater->fn('link', array('styles/templates', $__vars['style'], $__vars['linkParams'], ), false),
	...
	if ($__templater->isTraversable($__vars['types'])) {
		foreach ($__vars['types'] AS $__vars['typeId'] => $__vars['typeName']) {
			$__finalCompiled .= '
				<a href="' . $__templater->fn('link', array('styles/templates', $__vars['style'], array('type' => $__vars['typeId'], ) + $__vars['linkParams'], ), true) . '"
	...
	$__finalCompiled .= $__templater->dataList('
		...
		<div class="block-footer">
			<span class="block-footer-counter">' . $__templater->fn('display_totals', array($__vars['templates'], $__vars['total'], ), true) . '</span>
		</div>
	</div>
