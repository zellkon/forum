	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('
				...
				<strong><a href="' . $__templater->fn('link', array('banning/users', $__vars['userBan'], ), true) . '">' . $__templater->escape($__vars['userBan']['User']['username']) . '</a></strong>
			', array(
		'rowtype' => 'confirm',
	)) . '
...
', array(
		'action' => $__templater->fn('link', array('banning/users/lift', $__vars['userBan'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
