...
';
	...
	' . $__templater->button('Thêm quảng cáo', array(
		'href' => $__templater->fn('link', array('advertising/add', ), false),
		'icon' => 'add',
	), '', array(
	)) . '
');
					...
					if ($__templater->isTraversable($__vars['ads'][$__vars['positionId']])) {
						foreach ($__vars['ads'][$__vars['positionId']] AS $__vars['ad']) {
							$__compilerTemp1 .= '
								...
								'href' => $__templater->fn('link', array('advertising/edit', $__vars['ad'], ), false),
								'delete' => $__templater->fn('link', array('advertising/delete', $__vars['ad'], ), false),
							), array(array(
		...
		<div class="block-container">
			<div class="block-body">
				...
				<div class="block-footer">
					<span class="block-footer-counter">' . $__templater->fn('display_totals', array($__vars['totalAds'], ), true) . '</span>
				</div>
			</div>
		</div>
	', array(
			'action' => $__templater->fn('link', array('advertising/toggle', ), false),
			'class' => 'block',
			'ajax' => 'true',
		)) . '
';
