	...
	if ($__templater->isTraversable($__vars['diffs'])) {
		foreach ($__vars['diffs'] AS $__vars['diff']) {
			...
			if ($__vars['diff']['0'] == 'c') {
				...
				if ($__vars['diff']['3']) {
					$__compilerTemp2 .= '
										<span>' . (($__templater->fn('trim', array($__vars['parentHtml'], ), false) !== '') ? $__templater->filter($__vars['parentHtml'], array(array('raw', array()),), true) : '&nbsp;') . '</span>' . $__templater->formHiddenVal('', $__templater->filter($__vars['diff']['3'], array(array('join', array('
', )),), false), array(
					)) . '
									';
				} else {
...
', )),), false), array(
				...
				if ($__vars['diff']['1']) {
					$__compilerTemp3 .= '
										<span>' . (($__templater->fn('trim', array($__vars['diffHtml'], ), false) !== '') ? $__templater->filter($__vars['diffHtml'], array(array('raw', array()),), true) : '&nbsp;') . '</span>' . $__templater->formHiddenVal('', $__templater->filter($__vars['diff']['1'], array(array('join', array('
', )),), false), array(
					)) . '
									';
				} else {
				...
				if ($__vars['diff']['1']) {
					$__compilerTemp4 .= '
									<span>' . (($__templater->fn('trim', array($__vars['diffHtml'], ), false) !== '') ? $__templater->filter($__vars['diffHtml'], array(array('raw', array()),), true) : '&nbsp;') . '</span>' . $__templater->formHiddenVal('merged[]', $__templater->filter($__vars['diff']['1'], array(array('join', array('
', )),), false), array(
					)) . '
								';
				} else {
...
', array(
		'action' => $__templater->fn('link', array('templates/merge-outdated', $__vars['template'], ), false),
		'id' => 'js-mergeForm',
		'class' => 'block',
	)) . '
