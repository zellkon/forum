...
'addon_change_menu' => function($__templater, array $__arguments, array $__vars)
{
	...
	<div class="menu" data-menu="menu" aria-hidden="true">
		<div class="menu-content">
			...
			<a href="' . $__templater->fn('link', array($__vars['route'], $__vars['routeData'], array('addon_id' => null, ) + $__vars['routeParams'], ), true) . '"
	...
	if ($__templater->isTraversable($__vars['addOns'])) {
		foreach ($__vars['addOns'] AS $__vars['addOn']) {
			$__finalCompiled .= '
				<a href="' . $__templater->fn('link', array($__vars['route'], $__vars['routeData'], array('addon_id' => $__vars['addOn']['addon_id'], ) + $__vars['routeParams'], ), true) . '"
