...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	' . '' . $__templater->fn('username_link', array($__vars['user'], false, array('defaultname' => $__vars['newsFeed']['username'], ), ), true) . ' đã trả lời vào chủ đề ' . ((((('<a href="' . $__templater->fn('link', array('posts', $__vars['content'], ), true)) . '">') . $__templater->fn('prefix', array('thread', $__vars['content']['Thread'], ), true)) . $__templater->escape($__vars['content']['Thread']['title'])) . '</a>') . '.' . '
</div>
...
';
	...
	' . $__templater->callMacro('news_feed_attached_images', 'attached_images', array(
			...
			'link' => $__templater->fn('link', array('posts', $__vars['content'], ), false),
		), $__vars) . '
';
	}
	$__finalCompiled .= '
