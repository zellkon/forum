...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Diễn đàn quan tâm');
	$__finalCompiled .= '
			...
			'aria-haspopup' => 'true',
				...
				<div class="menu" data-menu="menu" aria-hidden="true">
					<div class="menu-content">
						...
						' . '
						<a href="' . $__templater->fn('link', array('watched/forums/manage', null, array('state' => 'watch_no_email', ), ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Tắt thông báo Email' . '</a>
...
';
		...
		$__finalCompiled .= '
	<div class="blockMessage">' . 'Bạn không quan tâm bất kỳ một diễn đàn nào.' . '</div>
';
	}
