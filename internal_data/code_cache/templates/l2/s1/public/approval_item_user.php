...
' . $__templater->formRadioRow(array(
	...
	array(
		'value' => 'reject',
		'label' => 'Từ chối với lý do từ chối' . $__vars['xf']['language']['label_separator'],
		...
		'html' => '
			<div class="formRow-explain">' . 'Thành viên bị từ chối sẽ không bị xóa nhưng trạng thái thành viên của họ sẽ được đặt là \'bị từ chối\'. Nếu một lý do được cung cấp ở trên, nó sẽ được hiển thị khi họ đăng nhập lần sau.' . '</div>
		',
		'_type' => 'option',
	)), array(
		'label' => 'Hành động',
