	...
	if ($__templater->isTraversable($__vars['editHistory'])) {
		foreach ($__vars['editHistory'] AS $__vars['historyId'] => $__vars['history']) {
			...
			array(
				'_type' => 'cell',
				'html' => '
							' . $__templater->fn('date_dynamic', array($__vars['history']['edit_date'], array(
			))) . '
						',
			),
			array(
				'_type' => 'cell',
				'html' => '
							' . $__templater->fn('username_link', array($__vars['history']['User'], false, array(
			))) . '
						',
			),
			array(
				'href' => $__templater->fn('link', array('edit-history/view', $__vars['history'], ), false),
				'overlay' => 'true',
				'_type' => 'action',
				'html' => '
							' . 'Xem' . '
...
', array(
		'action' => $__templater->fn('link', array('edit-history', ), false),
		'class' => 'block',
		'ajax' => 'true',
	));
