		...
		$__finalCompiled .= '
			...
			<div class="block-footer js-newsFeedLoadMore">
				<span class="block-footer-controls">' . $__templater->button('
					' . 'Hiển thị mục cũ hơn' . '
				', array(
			'href' => $__templater->fn('link', array('whats-new/news-feed', null, array('before_id' => $__vars['oldestItemId'], ), ), false),
			'rel' => 'nofollow',
		...
		$__finalCompiled .= '
			<div class="block-body js-newsFeedTarget">
				<div class="block-row">
					...
					<a href="' . $__templater->fn('link', array('account/following', ), true) . '">' . 'Theo dõi mọi người để hiển thị ở đây.' . '</a>
				</div>
			</div>
		';
	}
