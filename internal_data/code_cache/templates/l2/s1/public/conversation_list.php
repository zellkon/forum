...
';
	...
	' . $__templater->button('Bắt đầu một cuộc trò chuyện', array(
			'href' => $__templater->fn('link', array('conversations/add', ), false),
			'class' => 'button--cta',
			'icon' => 'write',
		), '', array(
		)) . '
...
<div class="block" data-xf-init="inline-mod" data-type="conversation" data-href="' . $__templater->fn('link', array('inline-mod', ), true) . '">
	...
	array(
		...
		'class' => 'button--primary',
						...
						', array(
		'action' => $__templater->fn('link', array('conversations/filters', ), false),
	)) . '
					</div>
				</div>
			</div>
