		...
		<div class="block-container">
			...
			<div class="block-body nestable-container" data-xf-init="nestable" data-max-depth="1" data-value-function="serialize">
				<ol class="nestable-list">
					';
	$__compilerTemp1 = $__templater->fn('array_keys', array($__vars['quotes'], ), false);
				...
				if ($__templater->isTraversable($__vars['quotes'][$__vars['messageId']])) {
					foreach ($__vars['quotes'][$__vars['messageId']] AS $__vars['key'] => $__vars['quote']) {
													...
													<div class="message-attribution">
														<div class="contentRow contentRow--alignMiddle">
															<div class="contentRow-figure">
																' . $__templater->fn('avatar', array($__vars['message'][$__vars['userRelation']], 'xxs', false, array(
							...
							'href' => '',
															...
															<div class="contentRow-main contentRow-main--close">
																<ul class="listInline listInline--bullet">
																	<li>' . $__templater->fn('username_link', array($__vars['message'][$__vars['userRelation']], false, array(
							'defaultname' => $__vars['message'][$__vars['usernameKey']],
							'href' => '',
						))) . '</li>
																	<li>' . $__templater->fn('date_dynamic', array($__vars['message'][$__vars['dateKey']], array(
						))) . '</li>
						...
						if ($__vars['quote'] === true) {
							$__finalCompiled .= '
															' . $__templater->fn('bb_code', array($__vars['message'][$__vars['messageKey']], $__vars['bbCodeContext'], $__vars['message'], ), true) . '
														';
						} else {
							$__finalCompiled .= '
															' . $__templater->fn('bb_code', array($__vars['quote'], $__vars['bbCodeContext'], $__vars['message'], ), true) . '
														';
						}
						$__finalCompiled .= '
													</article>
...
'button' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__vars['button'] = $__templater->preEscaped('
		' . $__templater->button('
			' . 'Chèn Trích dẫn' . $__vars['xf']['language']['ellipsis'] . '
		', array(
		...
		'data-add-message' => 'Bài viết đã được thêm vào trích dẫn.',
		'data-remove-message' => 'Bài viết được xóa khỏi nhiều trích dẫn',
		'icon' => 'quote',
	), '', array(
	)) . '
	');
