...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Sửa đối thoại');
	$__finalCompiled .= '
...
' . $__templater->form('
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['conversation'], 'title', ), false),
	), array(
		'label' => 'Tiêu đề',
	)) . '
...
', array(
		'action' => $__templater->fn('link', array('conversations/edit', $__vars['conversation'], ), false),
		'class' => 'block',
		'ajax' => 'true',
	));
