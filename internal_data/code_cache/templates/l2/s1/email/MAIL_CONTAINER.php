	...
	<td align="center" valign="top" id="bodyTableContainer">
		...
		<tr>
			<td class="header" align="center" valign="top">
				<a href="' . $__templater->fn('link', array('canonical:index', ), true) . '">' . $__templater->escape($__vars['xf']['options']['boardTitle']) . '</a>
			</td>
		</tr>
		<tr>
...
' . $__templater->filter($__vars['html'], array(array('raw', array()),), true) . '
		...
		<tr>
			<td class="footer" align="center" valign="top">
				<div>' . '<a href="' . $__templater->fn('link', array('canonical:index', ), true) . '">Truy cập ' . $__templater->escape($__vars['xf']['options']['boardTitle']) . '</a>' . '</div>
...
' . 'Truy cập ' . $__templater->escape($__vars['xf']['options']['boardTitle']) . ': ' . $__templater->fn('link', array('canonical:index', ), true) . '' . '
