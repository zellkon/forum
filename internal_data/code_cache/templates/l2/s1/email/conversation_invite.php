...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	' . '' . $__templater->escape($__vars['sender']['username']) . ' added you to the conversation "' . $__templater->escape($__vars['conversation']['title']) . '"' . '
</mail:subject>

' . '' . $__templater->escape($__vars['receiver']['username']) . ', ' . $__templater->escape($__vars['sender']['username']) . ' added you to an existing conversation at ' . (((('<a href="' . $__templater->fn('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.' . '
...
<tr>
	<td>
		<a href="' . $__templater->fn('link', array('canonical:conversations', $__vars['conversation'], ), true) . '" class="button">' . 'View This Conversation' . '</a>
	</td>
