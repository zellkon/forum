<?php
// FROM HASH: 13580782836fa25076c66e5df9a99e19
...
<div class="blockMessage">
	...
	$__finalCompiled .= '
		<li><a href="' . $__templater->fn('link', array('index', ), true) . '">' . 'Return to the forum home page' . '</a></li>
		';
	if ($__templater->method($__vars['xf']['visitor'], 'canEditProfile', array())) {
		$__finalCompiled .= '
			<li><a href="' . $__templater->fn('link', array('account', ), true) . '">' . 'Edit your account details' . '</a></li>
		';
	}
	$__finalCompiled .= '
	</ul>
