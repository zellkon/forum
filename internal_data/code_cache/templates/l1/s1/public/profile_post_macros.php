...
'profile_post' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__templater->method($__vars['profilePost'], 'canLike', array())) {
		...
		if ($__templater->method($__vars['profilePost'], 'isLiked', array())) {
			$__compilerTemp1 .= 'Unlike';
		} else {
			$__compilerTemp1 .= 'Like';
		}
		$__compilerTemp1 .= '</a>
									';
	}
	...
	if ($__templater->method($__vars['profilePost'], 'canReport', array())) {
		$__compilerTemp2 .= '
										<a href="' . $__templater->fn('link', array('profile-posts/report', $__vars['profilePost'], ), true) . '" class="actionBar-action actionBar-action--report" data-xf-click="overlay">' . 'Report' . '</a>
									';
	}
	$__compilerTemp2 .= '
...
'profile_post_deleted' => function($__templater, array $__arguments, array $__vars)
{
	...
	<div class="message message--simple' . ($__templater->method($__vars['profilePost'], 'isIgnored', array()) ? ' is-ignored' : '') . ' js-inlineModContainer"
		...
		'log' => $__vars['profilePost']['DeletionLog'],
					...
					<a href="' . $__templater->fn('link', array('profile-posts/show', $__vars['profilePost'], ), true) . '" class="u-jsOnly" data-xf-click="inserter" data-replace="[data-content=profile-post-' . $__templater->escape($__vars['profilePost']['profile_post_id']) . ']">' . 'Show' . $__vars['xf']['language']['ellipsis'] . '</a>
				</div>
			</div>
		</div>
	</div>
...
'profile_post_simple' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__finalCompiled .= '
			...
			<div class="contentRow-minor">
				...
				<a href="' . $__templater->fn('link', array('profile-posts', $__vars['profilePost'], ), true) . '" rel="nofollow" class="contentRow-extra" data-xf-click="overlay" data-xf-init="tooltip" title="' . $__templater->filter('Interact', array(array('for_attr', array()),), true) . '">&#8226;&#8226;&#8226;</a>
			</div>
		</div>
	</div>
';
