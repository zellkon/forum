...
<div class="block">
	...
	if ($__vars['user']['Profile']['birthday']['timeStamp']) {
		...
		if ($__vars['user']['Profile']['birthday']['age']) {
			$__compilerTemp3 .= '
											' . $__templater->fn('parens', array(('Age' . $__vars['xf']['language']['label_separator'] . ' ') . $__vars['user']['Profile']['birthday']['age'], ), true) . '
										';
		}
		$__compilerTemp3 .= '
									';
	...
	if ($__templater->method($__vars['user'], 'canViewIdentities', array())) {
		...
		if ($__templater->method($__vars['xf']['visitor'], 'canStartConversationWith', array($__vars['user'], ))) {
			$__compilerTemp4 .= '
								<dl class="pairs pairs--columns pairs--fixedSmall">
									<dt>' . 'Conversation' . '</dt>
									<dd><a href="' . $__templater->fn('link', array('conversations/add', '', array('to' => $__vars['user']['username'], ), ), true) . '">' . 'Start conversation' . '</a></dd>
								</dl>
							';
		}
		$__compilerTemp4 .= '
