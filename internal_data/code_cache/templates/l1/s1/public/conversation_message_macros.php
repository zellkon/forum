...
return array('macros' => array('message' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__templater->method($__vars['conversation'], 'canReply', array())) {
		...
		$__compilerTemp2 .= '
													<a href="' . $__templater->escape($__vars['quoteLink']) . '"
														...
														data-xf-click="quote"
														data-quote-href="' . $__templater->fn('link', array('conversations/messages/quote', $__vars['message'], ), true) . '">' . 'Reply' . '</a>
	...
	if ($__templater->method($__vars['message'], 'canReport', array())) {
		$__compilerTemp3 .= '
													<a href="' . $__templater->fn('link', array('conversations/messages/report', $__vars['message'], ), true) . '" class="actionBar-action actionBar-action--report" data-xf-click="overlay">' . 'Report' . '</a>
												';
	}
	$__compilerTemp3 .= '
