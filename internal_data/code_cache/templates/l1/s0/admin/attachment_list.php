<?php
// FROM HASH: 4d839e85c187cbf31e76c2cad51b506d
...
';
	...
	if (!$__templater->test($__vars['attachments'], 'empty', array())) {
		...
		if ($__templater->isTraversable($__vars['attachments'])) {
			foreach ($__vars['attachments'] AS $__vars['attachment']) {
				...
				array(
					...
					'href' => $__templater->fn('link', array('attachments/view', $__vars['attachment'], ), false),
					'_type' => 'cell',
					'html' => '
								' . $__compilerTemp6 . '
							',
					...
					'html' => '
								...
								<div class="dataList-subRow">
									<ul class="listInline listInline--bullet">
										<li>' . $__templater->fn('date_dynamic', array($__vars['attachment']['Data']['upload_date'], array(
				))) . '</li>
				...
				array(
					'href' => (((!$__vars['attachment']['unassociated']) AND $__templater->method($__vars['attachment'], 'getContainerLink', array())) ? $__templater->method($__vars['attachment'], 'getContainerLink', array()) : $__templater->fn('link', array('attachments/view', $__vars['attachment'], ), false)),
				...
				array(
					'href' => $__templater->fn('link', array('attachments/delete', $__vars['attachment'], $__vars['linkFilters'], ), false),
					'_type' => 'delete',
					'html' => '',
				))) . '
					';
		...
		$__compilerTemp4 .= $__templater->dataList('
			...
			<div class="block-footer block-footer--split">
				<span class="block-footer-counter">' . $__templater->fn('display_totals', array($__vars['attachments'], $__vars['total'], ), true) . '</span>
	...
	<div class="block-outer">
		...
		'name' => 'start',
		'value' => ($__vars['linkFilters']['start'] ? $__templater->fn('date', array($__vars['linkFilters']['start'], 'Y-m-d', ), false) : ''),
		'class' => 'filterBlock-input filterBlock-input--small',
	)) . '
						<span class="inputGroup-text">-</span>
						' . $__templater->formDateInput(array(
		'name' => 'end',
		'value' => ($__vars['linkFilters']['end'] ? $__templater->fn('date', array($__vars['linkFilters']['end'], 'Y-m-d', ), false) : ''),
		'class' => 'filterBlock-input filterBlock-input--small',
	)) . '
...
', array(
		'action' => $__templater->fn('link', array('attachments', ), false),
		'class' => 'block',
		'ajax' => 'true',
	)) . '
