<?php
// FROM HASH: f24bcb1405be99ae66ba23f46fad795f
...
<div class="js-importConfigForm">
	...
	if ($__vars['isCoreImporter'] AND $__vars['canRetainIds']) {
		...
		<div class="blockMessage blockMessage--warning blockMessage--iconic">
			' . 'In order to avoid unexpected user merges, please ensure your <a href="' . $__templater->fn('link', array('users/edit', $__vars['xf']['visitor'], ), true) . '" target="_blank">current user</a> is using a user name and email that is not used by any users in the source database!' . '
		</div>
	';
	}
	$__finalCompiled .= '
	...
	$__finalCompiled .= $__templater->form('
		...
		'explain' => 'This is the name of the database table which will hold information about this import. It may be used to aid with URL redirections. This table must be empty, or must not exist. Only use a-z, 0-9 and underscore characters.',
	)) . '
			</div>
	...
	', array(
		'action' => $__templater->fn('link', array('import/step-config', ), false),
		'class' => 'block',
		'ajax' => 'true',
