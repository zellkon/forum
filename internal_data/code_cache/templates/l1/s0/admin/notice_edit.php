...
';
	...
	<div class="block-container">
		...
		'explain' => 'The message to be shown when the display criteria are met. You may insert <b>{name}</b> to be replaced with the current visitor\'s user name and {title} to be replaced with this notice\'s title.',
	)) . '
	...
	array(
		...
		'label' => 'Visibility',
		'explain' => 'Use these settings to control visibility based on display size. These settings are linked to the <a href="' . $__templater->fn('link', array('styles/style-properties/group', array('style_id' => $__vars['xf']['options']['defaultStyleId'], ), array('group' => 'page', ), ), true) . '">responsive break point style properties</a> and may vary depending on the selected style.',
	)) . '
