<?php
// FROM HASH: cb46fae236497cd59e8e5bfb1af99956
...
';
	...
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['navigation'], 'navigation_id', ), false),
		'dir' => 'ltr',
	), array(
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['navigation'], 'link', ), false),
		'dir' => 'ltr',
	), array(
		'label' => 'Link',
	)) . '
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['navigation'], 'icon', ), false),
		'dir' => 'ltr',
	), array(
...
', array(
		'action' => $__templater->fn('link', array('admin-navigation/save', $__vars['navigation'], ), false),
		'class' => 'block',
		'ajax' => 'true',
	));
