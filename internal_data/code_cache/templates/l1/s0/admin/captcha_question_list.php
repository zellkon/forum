...
';
	...
	' . $__templater->button('Add question', array(
		'href' => $__templater->fn('link', array('captcha-questions/add', ), false),
		'icon' => 'add',
	), '', array(
	)) . '
');
	...
	';
		...
		if ($__templater->isTraversable($__vars['questions'])) {
			foreach ($__vars['questions'] AS $__vars['question']) {
				$__compilerTemp1 .= '
					...
					'href' => $__templater->fn('link', array('captcha-questions/edit', $__vars['question'], ), false),
				...
				array(
					'href' => $__templater->fn('link', array('captcha-questions/delete', $__vars['question'], ), false),
					'_type' => 'delete',
					'html' => '',
				))) . '
					';
		...
		<div class="block-container">
			...
			<div class="block-footer">
				<span class="block-footer-counter">' . $__templater->fn('display_totals', array($__vars['questions'], ), true) . '</span>
			</div>
		</div>
	', array(
