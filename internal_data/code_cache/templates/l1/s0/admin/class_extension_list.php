<?php
// FROM HASH: 927053ef688f29dfc276d2919a0699b6
...
';
	...
	' . $__templater->button('Add class extension', array(
		'href' => $__templater->fn('link', array('class-extensions/add', ), false),
		'icon' => 'add',
	), '', array(
	)) . '
');
	...
	';
				...
				if ($__templater->isTraversable($__vars['addOnExtensions'])) {
					foreach ($__vars['addOnExtensions'] AS $__vars['extension']) {
						$__compilerTemp1 .= '
							...
							'href' => $__templater->fn('link', array('class-extensions/edit', $__vars['extension'], ), false),
							'dir' => 'auto',
							'_type' => 'cell',
							'html' => '
										' . $__templater->escape($__vars['extension']['from_class']) . '
									',
						),
						array(
							'href' => $__templater->fn('link', array('class-extensions/edit', $__vars['extension'], ), false),
							...
							'_type' => 'cell',
							'html' => '
										' . $__templater->escape($__vars['extension']['to_class']) . '
									',
						),
						array(
						...
						array(
							'href' => $__templater->fn('link', array('class-extensions/delete', $__vars['extension'], ), false),
							'_type' => 'delete',
							'html' => '',
						))) . '
							';
		...
		<div class="block-container">
			...
			<div class="block-footer">
				<span class="block-footer-counter">' . $__templater->fn('display_totals', array($__vars['totalExtensions'], $__vars['total'], ), true) . '</span>
			</div>
		</div>
	', array(
			'action' => $__templater->fn('link', array('class-extensions/toggle', ), false),
			'class' => 'block',
			'ajax' => 'true',
		)) . '
';
