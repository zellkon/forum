<?php
// FROM HASH: 3ecff4cb03dade0fa0a525485448464e
...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->fn('link', array('widgets/delete', $__vars['widget'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
';
	...
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['widget'], 'widget_key', ), false),
		'dir' => 'ltr',
	), array(
		'label' => 'Widget key',
		'hint' => 'Required',
...
', array(
		'action' => $__templater->fn('link', array('widgets/save', $__vars['widget'], ), false),
		'class' => 'block',
		'ajax' => 'true',
	));
