...
'user_panes' => function($__templater, array $__arguments, array $__vars)
{
	...
	array(
		...
		'label' => 'User has received at least X likes' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formNumberBox(array(
	...
	array(
		...
		'label' => 'User likes to messages ratio is at least' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formNumberBox(array(
		...
		'afterhint' => 'A user with 10 messages and 5 likes will have a ratio of 0.5.',
		'_type' => 'option',
	),
	array(
