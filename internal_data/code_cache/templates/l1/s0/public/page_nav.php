...
return array('macros' => array('page_link' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['page'] == $__vars['current']) {
		$__finalCompiled .= '
		<li class="pageNav-page pageNav-page--current ' . $__templater->escape($__vars['pageClass']) . '"><a href="' . $__templater->fn('link', array($__vars['link'], $__vars['data'], $__vars['params'] + array($__vars['pageParam'] => (($__vars['page'] > 1) ? $__vars['page'] : null), ), ), true) . '">' . $__templater->escape($__vars['page']) . '</a></li>
	';
	} else {
		$__finalCompiled .= '
		<li class="pageNav-page ' . $__templater->escape($__vars['pageClass']) . '"><a href="' . $__templater->fn('link', array($__vars['link'], $__vars['data'], $__vars['params'] + array($__vars['pageParam'] => (($__vars['page'] > 1) ? $__vars['page'] : null), ), ), true) . '">' . $__templater->escape($__vars['page']) . '</a></li>
	';
	}
	$__finalCompiled .= '
';
...
'page_jump_menu' => function($__templater, array $__arguments, array $__vars)
{
	...
	<div class="menu menu--pageJump" data-menu="menu" aria-hidden="true">
		<div class="menu-content">
			...
			<div class="menu-row" data-xf-init="page-jump" data-page-url="' . $__templater->fn('link', array($__vars['link'], $__vars['data'], $__vars['params'] + array($__vars['pageParam'] => '%page%', ), ), true) . '">
...
{
	$__finalCompiled = '';
	$__finalCompiled .= '<nav class="pageNavWrapper pageNavWrapper--' . $__templater->fn('property', array('pageNavStyle', ), true) . ' ' . $__templater->escape($__vars['variantClass']) . '">
...
<div class="pageNavSimple">
	...
	if ($__vars['current'] > 1) {
		$__finalCompiled .= '
		<a href="' . $__templater->fn('link', array($__vars['link'], $__vars['data'], $__vars['params'] + array($__vars['pageParam'] => 1, ), ), true) . '"
			class="pageNavSimple-el pageNavSimple-el--first"
			data-xf-init="tooltip" title="' . $__templater->filter('First', array(array('for_attr', array()),), true) . '">
			<i aria-hidden="true"></i> <span class="u-srOnly">' . 'First' . '</span>
		</a>
		<a href="' . $__templater->fn('link', array($__vars['link'], $__vars['data'], $__vars['params'] + array($__vars['pageParam'] => $__vars['current'] - 1, ), ), true) . '" class="pageNavSimple-el pageNavSimple-el--prev">
	...
	if ($__vars['current'] < $__vars['totalPages']) {
		$__finalCompiled .= '
		<a href="' . $__templater->fn('link', array($__vars['link'], $__vars['data'], $__vars['params'] + array($__vars['pageParam'] => $__vars['current'] + 1, ), ), true) . '" class="pageNavSimple-el pageNavSimple-el--next">
