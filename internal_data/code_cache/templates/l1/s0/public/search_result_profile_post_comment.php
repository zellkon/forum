<?php
// FROM HASH: 1bcdd64278627d6a416c83c148490d23
	...
	<div class="contentRow ' . ((!$__templater->method($__vars['comment'], 'isVisible', array())) ? 'is-deleted' : '') . '">
		...
		<div class="contentRow-main">
			<h3 class="contentRow-title">
				<a href="' . $__templater->fn('link', array('profile-posts/comments', $__vars['comment'], ), true) . '">' . $__templater->fn('snippet', array($__vars['comment']['message'], 100, array('term' => $__vars['options']['term'], 'fromStart' => true, 'stripPlainTag' => true, ), ), true) . '</a>
			</h3>

			<div class="contentRow-snippet">' . $__templater->fn('snippet', array($__vars['comment']['message'], 300, array('term' => $__vars['options']['term'], 'stripPlainTag' => true, ), ), true) . '</div>
