...
';
	...
	<ul class="listInline listInline--bullet">
		<li>
			<i class="fa fa-users" aria-hidden="true" title="' . $__templater->filter('Participants', array(array('for_attr', array()),), true) . '"></i>
	...
	<div class="block">
		<div class="block-container">
			...
			<div class="block-body block-row block-row--minor">
				...
				<dl class="pairs pairs--justified"><dt>' . 'Last reply date' . '</dt> <dd>' . $__templater->fn('date_dynamic', array($__vars['conversation']['last_message_date'], array(
	))) . '</dd></dl>
				<dl class="pairs pairs--justified"><dt>' . 'Last reply from' . '</dt> <dd>' . $__templater->fn('username_link', array($__vars['conversation']['LastMessageUser'], false, array(
	))) . '</dd></dl>
			</div>
		</div>
	</div>
