...
';
	$__templater->breadcrumb($__templater->preEscaped('Reports'), $__templater->fn('link', array('reports', ), false), array(
	));
	$__finalCompiled .= '
';
...
<div class="block">
	<div class="block-container">
		...
		<h2 class="block-tabHeader tabs" data-xf-init="tabs" role="tablist">
			<a class="tabs-tab is-active" role="tab" tabindex="0" aria-controls="' . $__templater->fn('unique_id', array('reportUpdate', ), true) . '">' . 'Update' . '</a>
			<a class="tabs-tab" role="tab" tabindex="0" aria-controls="' . $__templater->fn('unique_id', array('reportReassign', ), true) . '">' . 'Reassign' . '</a>
		</h2>
