...
return array('macros' => array('popup_item' => function($__templater, array $__arguments, array $__vars)
{
		...
		<div class="fauxBlockLink">
			<div class="contentRow">
				<div class="contentRow-figure">
					' . $__templater->fn('avatar', array($__vars['userConv']['Master']['LastMessageUser'], 'xxs', false, array(
		'defaultname' => $__vars['userConv']['Master']['last_message_username'],
	))) . '
				</div>
				<div class="contentRow-main contentRow-main--close">
					<a href="' . $__templater->fn('link', array('conversations' . ($__templater->method($__vars['userConv'], 'isUnread', array()) ? '/unread' : ''), $__vars['userConv'], ), true) . '" class="fauxBlockLink-blockLink">' . $__templater->escape($__vars['userConv']['Master']['title']) . '</a>
	...
	$__finalCompiled .= '
					...
					<div class="contentRow-minor contentRow-minor--smaller">
						' . $__templater->fn('date_dynamic', array($__vars['userConv']['Master']['last_message_date'], array(
	))) . '
					</div>
				</div>
			</div>
