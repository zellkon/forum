...
';
	$__templater->breadcrumb($__templater->preEscaped('Tags'), $__templater->fn('link', array('tags', ), false), array(
	));
	$__finalCompiled .= '
...
';
	...
	if ($__vars['xf']['options']['enableTagging']) {
		$__compilerTemp2 .= '
					<a href="' . $__templater->fn('link', array('tags', ), true) . '" class="tabs-tab is-active">' . 'Search tags' . '</a>
				';
	}
	...
	<div class="block-container">
		<h2 class="block-tabHeader tabs hScroller" data-xf-init="h-scroller">
			<span class="hScroller-scroll">
				<a href="' . $__templater->fn('link', array('search', ), true) . '" class="tabs-tab">' . 'Search everything' . '</a>
				' . $__compilerTemp1 . '
				' . $__compilerTemp2 . '
			</span>
		</h2>
