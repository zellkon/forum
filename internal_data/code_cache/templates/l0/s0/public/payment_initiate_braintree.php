			...
			<div class="block-body">
				' . $__templater->formRow('
					<div class="inputGroup">
						<div class="inputGroup-text"><span style="width: 30px;"><i class="fa fa-lg fa-credit-card-alt" id="brand-icon"></i></span></div>
				...
				<script type="application/json" class="js-formStyles">
					{
						"input": {
							...
							"font-family": "' . $__templater->fn('property', array('fontFamilyUi', ), true) . '",
							"font-size": "16px",
							"line-height": "' . $__templater->fn('property', array('lineHeightDefault', '1.4', ), true) . '"
						},
						"input.invalid": {
							"color": "#c84448"
						}
