	...
	if ($__templater->isTraversable($__vars['interfaceGroups'])) {
		...
		';
			...
			<div class="block-body block-body--collapsible is-active"
				...
				';
				if ($__templater->fn('count', array($__vars['permissionsGrouped'][$__vars['interfaceGroupId']], ), false) > 2) {
					$__finalCompiled .= '
					' . $__templater->formRow('
						' . $__templater->button('Quick set', array(
						'class' => 'button--link menuTrigger',
		...
		$__compilerTemp1 .= '
			...
			'_type' => 'option',
				...
				<li class="permissionChoices-choice permissionChoices-choice--int">
					<div class="inputGroup inputGroup--inline inputGroup--joined inputNumber" data-xf-init="number-box">
						<label class="iconic iconic--radio inputGroup-text">
							<input type="radio" name="' . $__templater->escape($__vars['inputName']) . '" value="1"
								data-xf-init="disabler"
								data-container="< li"
								' . (($__vars['value'] >= 1) ? 'checked="checked"' : '') . ' />
							<i aria-hidden="true"></i><span class="u-srOnly">' . 'As follows' . $__vars['xf']['language']['label_separator'] . '</span>
						</label>
						' . $__templater->formTextBox(array(
			'type' => 'number',
