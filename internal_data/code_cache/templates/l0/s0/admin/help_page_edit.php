<?php
// FROM HASH: 8c87703261b645fd776ba9f585052b44
...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->fn('link', array('help-pages/delete', $__vars['page'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
' . $__templater->form('
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['page'], 'page_name', ), false),
	), array(
		'label' => 'URL portion',
		'explain' => '
		...
		'explain' => (($__vars['xf']['debug'] AND $__vars['page']['addon_id']) ? 'The value of this field will not be changed when this add-on is upgraded.' : ''),
	), $__vars) . '
...
<ol>
	...
	<li><code>\\XF\\Mvc\\Reply\\AbstractReply &$reply</code><br />The standard reply from the page controller.</li>
		...
		'hint' => (($__vars['xf']['debug'] AND $__vars['page']['addon_id']) ? 'The value of this field will not be changed when this add-on is upgraded.' : ''),
		'label' => '
					' . 'Enabled' . '
				',
		'_type' => 'option',
...
', array(
		'action' => $__templater->fn('link', array('help-pages/save', $__vars['page'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
