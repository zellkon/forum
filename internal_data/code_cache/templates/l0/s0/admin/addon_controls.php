...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if ($__vars['hasOptions']) {
		$__compilerTemp2 .= '
					<a href="' . (($__vars['hasOptions'] === true) ? $__templater->fn('link', array('add-ons/options', $__vars['addOn'], ), true) : $__templater->fn('link', array($__vars['hasOptions'], ), true)) . '" class="menu-linkRow">' . 'Options' . '</a>
				';
	}
	$__compilerTemp2 .= '
				';
	...
	if ($__vars['hasAdminTemplates']) {
		$__compilerTemp2 .= '
					<a href="' . $__templater->fn('link', array('styles/templates', $__vars['masterStyle'], array('addon_id' => $__vars['addOn']['addon_id'], 'type' => 'admin', ), ), true) . '" class="menu-linkRow">' . 'Admin templates' . '</a>
				';
	}
	$__compilerTemp2 .= '
				';
	if ($__vars['hasPhrases']) {
		$__compilerTemp2 .= '
					<a href="' . $__templater->fn('link', array('languages/phrases', $__vars['language'], array('addon_id' => $__vars['addOn']['addon_id'], ), ), true) . '" class="menu-linkRow">' . 'Phrases' . '</a>
				';
	}
	$__compilerTemp2 .= '
			';
	...
	if (($__templater->method($__vars['addOn'], 'isInstalled', array()) OR $__templater->method($__vars['addOn'], 'canUpgrade', array())) AND (!$__templater->method($__vars['addOn'], 'isLegacy', array()))) {
		$__compilerTemp3 .= '
					<a href="' . $__templater->fn('link', array('add-ons/toggle', $__vars['addOn'], array('t' => $__templater->fn('csrf_token', array(), false), ), ), true) . '" class="menu-linkRow">' . ($__vars['addOn']['active'] ? 'Disable' : 'Enable') . '</a>
				';
	}
	$__compilerTemp3 .= '
				';
	...
	if ($__templater->method($__vars['addOn'], 'isFileVersionValid', array()) AND $__templater->method($__vars['addOn'], 'canRebuild', array())) {
		$__compilerTemp3 .= '
					<a href="' . $__templater->fn('link', array('add-ons/rebuild', $__vars['addOn'], ), true) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Rebuild' . '</a>
				';
	}
	$__compilerTemp3 .= '
				';
	if ($__templater->method($__vars['addOn'], 'isInstalled', array()) AND (!$__templater->method($__vars['addOn'], 'canUpgrade', array()))) {
		$__compilerTemp3 .= '
					<a href="' . $__templater->fn('link', array('add-ons/uninstall', $__vars['addOn'], ), true) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Uninstall' . '</a>
				';
	}
	$__compilerTemp3 .= '
			';
