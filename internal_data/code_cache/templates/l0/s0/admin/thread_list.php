<?php
// FROM HASH: 7f4bb0be2c5da64d0a1c239f4545fc10
	...
	';
		...
		if ($__templater->isTraversable($__vars['threads'])) {
			foreach ($__vars['threads'] AS $__vars['thread']) {
				...
				$__compilerTemp3[] = array(
					'href' => $__templater->fn('link_type', array('public', 'threads', $__vars['thread'], ), false),
				...
				$__compilerTemp3[] = array(
					...
					'_type' => 'cell',
					'html' => '
								' . $__templater->fn('date_dynamic', array($__vars['thread']['last_post_date'], array(
				))) . '
							',
				);
		...
		if ($__vars['showAll']) {
			$__compilerTemp5 .= '
					<span class="block-footer-controls">
						<a href="' . $__templater->fn('link', array('threads/list', null, array('criteria' => $__vars['criteria'], 'all' => true, ), ), true) . '">' . 'Show all matches' . '</a>
					</span>
				';
		...
		<div class="block-container">
			...
			<div class="block-footer block-footer--split">
				<span class="block-footer-counter">' . $__templater->fn('display_totals', array($__vars['threads'], $__vars['total'], ), true) . '</span>
