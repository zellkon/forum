...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	' . $__templater->button('Add field', array(
		'href' => $__templater->fn('link', array($__vars['prefix'] . '/add', ), false),
		'icon' => 'add',
	), '', array(
	)) . '
');
	...
	';
		...
		<div class="block-container">
			...
			<div class="block-footer">
				<span class="block-footer-counter">' . $__templater->fn('display_totals', array($__vars['displayGroups'], ), true) . '</span>
			</div>
		</div>
	', array(
			'action' => $__templater->fn('link', array($__vars['prefix'] . '/toggle', ), false),
			'class' => 'block',
			'ajax' => 'true',
		)) . '
';
