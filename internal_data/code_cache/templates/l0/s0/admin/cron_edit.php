<?php
// FROM HASH: 5462e4646fb38911ab12323d4279c5da
...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->fn('link', array('cron/delete', $__vars['entry'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
' . $__templater->form('
	...
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['entry'], 'entry_id', ), false),
	...
	array(
		...
		'hint' => (($__vars['xf']['debug'] AND $__vars['entry']['addon_id']) ? 'The value of this field will not be changed when this add-on is upgraded.' : ''),
		'label' => '
...
', array(
		'action' => $__templater->fn('link', array('cron/save', $__vars['entry'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
