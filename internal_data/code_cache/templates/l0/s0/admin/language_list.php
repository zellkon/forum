<?php
// FROM HASH: 582dd7cafd29440b52a06e42e6b1d410
...
'language_list_entry' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__compilerTemp1 = array(array(
		...
		'href' => ($__vars['language']['language_id'] ? $__templater->fn('link', array('languages/edit', $__vars['language'], ), false) : ''),
	...
	if ($__templater->method($__vars['language'], 'canEdit', array())) {
		$__compilerTemp1[] = array(
			'href' => $__templater->fn('link', array('languages/phrases', $__vars['language'], ), false),
	...
	if ($__vars['language']['language_id']) {
		$__compilerTemp1[] = array(
			'href' => $__templater->fn('link', array('languages/export', $__vars['language'], ), false),
			'overlay' => 'true',
			'class' => 'dataList-cell--responsiveMenuItem',
			'_type' => 'action',
			'html' => 'Export',
...
';
	...
	' . $__templater->button('Add language', array(
		'href' => $__templater->fn('link', array('languages/add', ), false),
		'icon' => 'add',
	), '', array(
	)) . '
	' . $__templater->button('', array(
		'href' => $__templater->fn('link', array('languages/import', ), false),
		'icon' => 'import',
	), '', array(
	)) . '
');
	...
	' . $__templater->form('
		...
		<div class="block-container">
			...
			<div class="block-footer">
				<span class="block-footer-counter">' . $__templater->fn('display_totals', array($__templater->method($__vars['languageTree'], 'getFlattened', array(0, )), ), true) . '</span>
			</div>
		</div>
		' . $__templater->formHiddenVal('default_language_id_original', $__vars['xf']['options']['defaultLanguageId'], array(
		)) . '
	', array(
			'action' => $__templater->fn('link', array('languages/toggle', ), false),
			'class' => 'block',
			'ajax' => 'true',
		)) . '
';
