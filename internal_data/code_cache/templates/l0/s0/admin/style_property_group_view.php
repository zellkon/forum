...
';
	$__templater->breadcrumb($__templater->preEscaped($__templater->escape($__vars['style']['title']) . ' - ' . 'Style properties'), $__templater->fn('link', array('styles/style-properties', $__vars['style'], ), false), array(
	));
	$__finalCompiled .= '
