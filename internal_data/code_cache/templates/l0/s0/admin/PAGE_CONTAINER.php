...
<footer class="p-footer">
	<div class="p-footer-row">
		<div class="p-footer-row-main">
			<a href="' . $__templater->fn('link', array('login/logout', null, array('t' => $__templater->fn('csrf_token', array(), false), ), ), true) . '">' . 'Log out' . '</a>
		</div>
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canChangeLanguage', array())) {
		$__finalCompiled .= '
				<a href="' . $__templater->fn('link', array('languages/admin', ), true) . '" data-xf-click="overlay" data-xf-init="tooltip" title="' . $__templater->filter('Language chooser', array(array('for_attr', array()),), true) . '">
