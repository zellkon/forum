...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->fn('link', array('user-group-promotions/delete', $__vars['userGroupPromotion'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
';
	...
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['userGroupPromotion'], 'title', ), false),
	), array(
		'label' => 'Title',
	)) . '
...
', array(
		'action' => $__templater->fn('link', array('user-group-promotions/save', $__vars['userGroupPromotion'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
