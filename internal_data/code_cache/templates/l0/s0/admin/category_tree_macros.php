<?php
// FROM HASH: bfb1db5e802a12e310cd559ac0099e36
return array('macros' => array('page_action' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
		...
		'href' => $__templater->fn('link', array($__vars['linkPrefix'] . '/sort', ), false),
		'icon' => 'sort',
		'overlay' => 'true',
	), '', array(
	)) . '
		...
		if ($__templater->isTraversable($__compilerTemp2)) {
			foreach ($__compilerTemp2 AS $__vars['treeEntry']) {
				...
				$__compilerTemp3 = array(array(
					...
					'_type' => 'cell',
					'html' => '
									<a href="' . $__templater->fn('link', array($__vars['linkPrefix'] . '/edit', $__vars['category'], ), true) . '">
				...
				if ($__vars['permissionContentType']) {
					$__compilerTemp3[] = array(
						...
						'href' => $__templater->fn('link', array($__vars['linkPrefix'] . '/permissions', $__vars['category'], ), false),
						'_type' => 'action',
						'html' => '
										' . 'Permissions' . '
									',
					...
					'html' => '
									...
									<div class="menu" data-menu="menu" aria-hidden="true">
										<div class="menu-content">
											...
											<a href="' . $__templater->fn('link', array($__vars['linkPrefix'] . '/add', null, array($__vars['parentIdKey'] => $__vars['category'][$__vars['parentIdKey']], ), ), true) . '" class="menu-linkRow">' . 'Sibling' . '</a>
											<a href="' . $__templater->fn('link', array($__vars['linkPrefix'] . '/add', null, array($__vars['parentIdKey'] => $__vars['category'][$__vars['idKey']], ), ), true) . '" class="menu-linkRow">' . 'Child' . '</a>
										</div>
									</div>
								',
				);
				$__compilerTemp3[] = array(
					'href' => $__templater->fn('link', array($__vars['linkPrefix'] . '/delete', $__vars['category'], ), false),
					'_type' => 'delete',
					'html' => '',
				);
...
'sortable_form' => function($__templater, array $__arguments, array $__vars)
{
	...
	', array(
		'action' => $__templater->fn('link', array($__vars['linkPrefix'] . '/sort', ), false),
		'class' => 'block',
		'ajax' => 'true',
	)) . '
';
...
'category_delete_form' => function($__templater, array $__arguments, array $__vars)
{
		...
		<div class="block-container">
			<div class="block-body">
				' . $__templater->formInfoRow('
					...
					<strong><a href="' . $__templater->fn('link', array($__vars['linkPrefix'] . '/edit', $__vars['category'], ), true) . '">' . $__templater->escape($__vars['category']['title']) . '</a></strong>
				', array(
		'rowtype' => 'confirm',
	)) . '
	...
	', array(
		'action' => $__templater->fn('link', array($__vars['linkPrefix'] . '/delete', $__vars['category'], ), false),
		'class' => 'block',
		'ajax' => 'true',
	)) . '
';
