<?php
// FROM HASH: 2c07f52bfb6e5614df90440990d23ef4
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Sort navigation');
	$__finalCompiled .= '
...
', array(
		'action' => $__templater->fn('link', array('navigation/sort', ), false),
		'class' => 'block',
		'ajax' => 'true',
	)) . '
