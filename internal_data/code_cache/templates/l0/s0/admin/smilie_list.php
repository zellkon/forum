		...
		'title' => $__templater->filter('More options', array(array('for_attr', array()),), false),
			...
			<div class="menu" data-menu="menu" aria-hidden="true">
				<div class="menu-content">
					...
					<a href="' . $__templater->fn('link', array('smilies/sort', ), true) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Sort' . '</a>
					<a href="' . $__templater->fn('link', array('smilies/import', ), true) . '" class="menu-linkRow">' . 'Import' . '</a>
					<a href="' . $__templater->fn('link', array('smilies', array(), array('export' => 1, ), ), true) . '" class="menu-linkRow">' . 'Export' . '</a>
				</div>
			</div>
		</div>
	</div>
...
';
	...
	<div class="block-container">
		...
		<h2 class="block-tabHeader tabs" role="tablist">
			' . '
			<a class="tabs-tab ' . ($__vars['exportView'] ? '' : 'is-active') . '" role="tab" tabindex="0" aria-controls="smilie-list" href="' . $__templater->fn('link', array('smilies', ), true) . '">' . 'Smilies' . '</a>
			<a class="tabs-tab ' . ($__vars['exportView'] ? 'is-active' : '') . '" role="tab" tabindex="0" aria-controls="export-mode" href="' . $__templater->fn('link', array('smilies', array(), array('export' => 1, ), ), true) . '">' . 'Export' . '</a>
			' . '
		</h2>
