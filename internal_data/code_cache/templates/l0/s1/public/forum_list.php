...
' . $__templater->callMacro('metadata_macros', 'metadata', array(
		...
		'canonicalUrl' => $__templater->fn('link', array('canonical:' . $__vars['selfRoute'], ), false),
	), $__vars) . '
...
';
	$__templater->setPageParam('head.' . 'rss_forum', $__templater->preEscaped('<link rel="alternate" type="application/rss+xml" title="' . $__templater->filter('RSS feed for ' . $__vars['xf']['options']['boardTitle'] . '', array(array('for_attr', array()),), true) . '" href="' . $__templater->fn('link', array('forums/index.rss', '-', ), true) . '" />'));
	$__finalCompiled .= '
