	...
	<div class="block-container">
		<h2 class="block-tabHeader tabs hScroller" data-xf-init="h-scroller">
			<span class="hScroller-scroll">
				' . '
				<a href="' . $__templater->fn('link', array('online', ), true) . '" class="tabs-tab ' . (($__vars['typeLimit'] == '') ? 'is-active' : '') . '">' . 'Everyone' . '</a>
				<a href="' . $__templater->fn('link', array('online', null, array('type' => 'member', ), ), true) . '" class="tabs-tab ' . (($__vars['typeLimit'] == 'member') ? 'is-active' : '') . '">' . 'Members' . '</a>
				<a href="' . $__templater->fn('link', array('online', null, array('type' => 'guest', ), ), true) . '" class="tabs-tab ' . (($__vars['typeLimit'] == 'guest') ? 'is-active' : '') . '">' . 'Guests' . '</a>
				<a href="' . $__templater->fn('link', array('online', null, array('type' => 'robot', ), ), true) . '" class="tabs-tab ' . (($__vars['typeLimit'] == 'robot') ? 'is-active' : '') . '">' . 'Robots' . '</a>
				' . '
			</span>
		</h2>
		';
