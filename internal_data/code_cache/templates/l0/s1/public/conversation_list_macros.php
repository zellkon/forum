...
return array('macros' => array('item' => function($__templater, array $__arguments, array $__vars)
{
	...
	<div class="structItem structItem--conversation ' . ($__templater->method($__vars['userConv'], 'isUnread', array()) ? 'is-unread' : '') . ' js-inlineModContainer" data-author="' . ($__templater->escape($__vars['userConv']['Master']['Starter']['username']) ?: $__templater->escape($__vars['userConv']['Master']['username'])) . '">
		<div class="structItem-cell structItem-cell--icon">
			<div class="structItem-iconContainer">
				' . $__templater->fn('avatar', array($__vars['userConv']['Master']['Starter'], 's', false, array(
	...
	$__finalCompiled .= '
			...
			<a href="' . $__templater->fn('link', array('conversations' . ($__templater->method($__vars['userConv'], 'isUnread', array()) ? '/unread' : ''), $__vars['userConv'], ), true) . '" class="structItem-title" data-tp-primary="on">' . $__templater->escape($__vars['userConv']['title']) . '</a>
	...
	$__finalCompiled .= '
		...
		<div class="structItem-cell structItem-cell--latest">
			<a href="' . $__templater->fn('link', array('conversations/latest', $__vars['userConv'], ), true) . '" rel="nofollow">' . $__templater->fn('date_dynamic', array($__vars['userConv']['last_message_date'], array(
		'class' => 'structItem-latestDate',
	))) . '</a>
			<div class="structItem-minor">' . $__templater->fn('username_link', array($__vars['userConv']['Master']['last_message_cache'], false, array(
	))) . '</div>
		</div>
	</div>
';
