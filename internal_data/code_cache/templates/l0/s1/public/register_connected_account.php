		...
		<ul class="tabPanes">
			...
			<li role="tabpanel" id="' . $__templater->fn('unique_id', array('regAssoc', ), true) . '">
				<div class="block-body block-row">
					' . 'To associate with an existing account, you must first log into that account and then start the association via the <a href="' . $__templater->fn('link', array('account/connected-accounts', ), true) . '">connected accounts area</a>.' . '
				</div>
			</li>
		</ul>
	</div>
