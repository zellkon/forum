...
c[g].breakpoint&&(d=c[g].settings.item);if(!(this.$items.length<=d)){this.slider=this.$target.lightSlider({item:a.items,addClass:"carousel-scrollContainer",slideMargin:0,galleryMargin:0,controls:!1,auto:!0,pause:a.pause,speed:Modernizr.flexbox?400:0,pauseOnHover:!0,loop:!0,rtl:XF.isRtl(),enableDrag:!1,responsive:c});var h=this;e(f).on("resize",function(){h.$target.css("height","");h.slider.refresh()})}}else console.error("Lightslider must be loaded")}});XF.Element.register("carousel","XF.Carousel")}(jQuery,
window,document);
