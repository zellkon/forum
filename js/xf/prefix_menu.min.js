...
{groups:a}))},reset:function(){this.selectPrefix(this.initialPrefixId)},loadPrefixes:function(a){XF.ajax("POST",this.options.href,{val:b(a.target).val()},XF.proxy(this,"loadSuccess"))},loadSuccess:function(a){if(a.html){var e=this,c=this.$select;XF.setupHtmlInsert(a.html,function(a){a.each(function(){var a=b(this);if(a.is("select")){var g=c.val();c.empty().append(a.children());c.find('option[value="'+g+'"]').length||(g=0);e.initMenu();e.selectPrefix(g);return!1}})})}},toggleActive:function(a){a=b(a.target);
var e=this.$active.closest(".inputGroup-text");e.length&&(a.is(":disabled")?e.addClass("inputGroup-text--disabled"):e.removeClass("inputGroup-text--disabled"))},selectPrefix:function(a){a=parseInt(a,10);var b=this.$active,c=this.$select,d=c.find('option[value="'+a+'"]');d.length||(a=0,d=c.find('option[value="'+a+'"]'));var h=d.data("prefix-class");c.val(a);b.text(d.text()).removeClass(b.data("prefix-class")).addClass(h);b.data("prefix-class",h)},prefixClick:function(a){this.selectPrefix(b(a.target).data("prefix-id"));
