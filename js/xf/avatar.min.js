...
!function(a,d,c,f){XF.AvatarUpload=XF.Element.newHandler({options:{},init:function(){var a=this.$target,b=a.find(".js-uploadAvatar"),c=a.find(".js-avatar"),d=a.find(".js-deleteAvatar");c.find("img").length?d.show():d.hide();b.on("change",XF.proxy(this,"changeFile"));a.on("ajax-submit:response",XF.proxy(this,"ajaxResponse"))},changeFile:function(e){""!=a(e.target).val()&&this.$target.submit()},ajaxResponse:function(e,b){if(!b.errors&&!b.exception){e.preventDefault();b.message&&XF.flashMessage(b.message,
3E3);var c=this.$target;e=c.find(".js-deleteAvatar");var d=c.find(".js-uploadAvatar"),f=c.find(".js-avatar"),g=c.find(".js-avatarX"),h=c.find(".js-avatarY");if(c=1==c.find('input[name="use_custom"]:checked').val())f.css({left:-1*b.cropX,top:-1*b.cropX}),g.val(b.cropX),h.val(b.cropY),f.data("x",b.cropX),f.data("y",b.cropY),XF.Element.initializeElement(f),d.val("");else if(a(".js-gravatarPreview").attr("src",b.gravatarTest?b.gravatarPreview:b.gravatarUrl),b.gravatarTest)return;XF.updateAvatars(b.userId,
b.avatars,c);b.defaultAvatars?e.hide():e.show();a(".js-avatarCropper").trigger("avatar:updated",b)}}});XF.AvatarCropper=XF.Element.newHandler({options:{size:96,x:0,y:0},$img:null,size:96,x:0,y:0,imgW:null,imgH:null,cropSize:null,scale:null,init:function(){this.$target.one("avatar:updated",XF.proxy(this,"avatarsUpdated"));this.$img=this.$target.find("img");this.$img.length&&this.initTest()},avatarsUpdated:function(a,b){this.options.x=b.cropX;this.options.y=b.cropY;this.init()},initTest:function(){var a=
this.$img[0],b=0,c=this,d=function(){b++;50<b||(0<a.naturalWidth?c.setup():0===a.naturalWidth&&setTimeout(d,100))};d()},setup:function(){this.imgW=this.$img[0].naturalWidth;this.imgH=this.$img[0].naturalHeight;this.cropSize=Math.min(this.imgW,this.imgH);this.scale=this.cropSize/this.options.size;this.$img.cropbox({width:this.size,height:this.size,zoom:0,maxZoom:0,controls:!1,showControls:"never",result:{cropX:this.options.x*this.scale,cropY:this.options.y*this.scale,cropW:this.cropSize,cropH:this.cropSize}}).on("cropbox",
XF.proxy(this,"onCrop"))},onCrop:function(a,b){this.$target.parent().find(".js-avatarX").val(b.cropX/this.scale);this.$target.parent().find(".js-avatarY").val(b.cropY/this.scale)}});XF.Element.register("avatar-upload","XF.AvatarUpload");XF.Element.register("avatar-cropper","XF.AvatarCropper")}(jQuery,window,document);
