...
g);XF.layoutChange()},getRowValue:function(a){a=a.find("input, select").serializeArray();a=a[a.length-1].value;a.match(/^[0-9]+$/)&&(a=parseInt(a,10));return a},isValueSet:function(a){if("number"==typeof a)return 0!=a;switch(a){case "allow":case "content_allow":case "reset":case "deny":return!0;default:return!1}},isRowValueSet:function(a){return this.isValueSet(this.getRowValue(a))},onKeyUp:function(a){if(!a.ctrlKey&&!a.metaKey){switch(a.which){case 9:case 13:case 16:case 17:case 18:break;default:this.planFilter()}13!=
a.keyCode&&this.planFilter()}},onKeyPress:function(a){13==a.which&&(a.preventDefault(),this.filter())},onPaste:function(a){this.planFilter()},planFilter:function(){this.filterTimer&&clearTimeout(this.filterTimer);this.filterTimer=setTimeout(XF.proxy(this,"filter"),250)},filter:function(){this.filterTimer&&clearTimeout(this.filterTimer);var a=this.$filter.val(),c=this.groups,g=this.options.rowLabel;if(a.length){var d=new RegExp("("+XF.regexQuote(a)+")","i");var e=new RegExp("("+XF.regexQuote(XF.htmlspecialchars(a))+
")","i")}else e=d=!1;var f=!1,l;for(l in c)if(c.hasOwnProperty(l)){var m=!1,n=!1;a=c[l];a.$rows.find(".textHighlight").each(function(){var a=this.parentNode;b(this).replaceWith(this.childNodes);a.normalize()});a.$rows.each(function(){var a=b(this),c=!1;if(d){var h=a.find(g),k=h.text();d.test(k)&&(c=!0,k=XF.htmlspecialchars(k).replace(e,'<span class="textHighlight textHighlight--attention">$1</span>'),h.html(k))}else c=!0;a.css("display",c?"":"none");c?m=!0:f=n=!0});d&&!m?(a.$group.css("display","none"),
a.$header.css("display","none")):(a.$group.css("display",""),a.$header.css("display",""),a.$group.find(".formRow--permissionQuickSet").css("display",n?"none":""),d&&this.setGroupExpandedState(a.$group,a.$header,!0))}this.$form.find(".js-globalPermissionQuickSet").css("display",f?"none":"");XF.layoutChange()},triggerQuickSet:function(a){var c=a.data("value");a=a.data("target");var d=null,e=this;a&&a.length&&(d=b(a),d.length||(d=null));d||(d=this.$form);d.find(this.options.rows).each(function(){e.setRowValue(b(this),
...
inputContainerSelector:"li"},init:function(){var a=this;this.$target.on("click",this.options.inputSelector,function(){setTimeout(function(){a.update()},0)});this.update()},update:function(){var a=this.options.inputContainerSelector;this.$target.find(this.options.inputSelector).each(function(){var c=b(this);c.closest(a).toggleClass("is-selected",c.prop("checked"))})}});XF.Element.register("permission-form","XF.PermissionForm");XF.Element.register("permission-choice","XF.PermissionChoice")}(jQuery,
window,document);
