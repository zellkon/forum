...
for(f in h.colors)if(h.colors.hasOwnProperty(f)&&(!d||d!==f)){var l=h.colors[f];var m=XF.Color.fromString(l.value);k+='<div class="colorPicker-property'+(m?"":" is-unknown")+'" data-property="'+XF.htmlspecialchars(f)+'"><span class="colorPicker-property-preview" style="background-color: '+XF.htmlspecialchars(m?m.toCss():"transparent")+'"></span>'+XF.htmlspecialchars(l.title)+"</div>"}a.push(h.title);b.push('<div class="colorPicker-propertyContainer">'+k+"</div>")}}a.push(XF.phrase("picker"));b.push('<div class="colorPicker-sliders" dir="ltr"><div class="colorPicker-hue"><div class="colorPicker-hue-bar"><span class="colorPicker-hue-indicator"></span></div></div><div class="colorPicker-colorGrad"><div class="colorPicker-colorGrad-color"><div class="colorPicker-colorGrad-sat"><div class="colorPicker-colorGrad-val"><span class="colorPicker-colorGrad-indicator"></span></div></div></div></div><div class="colorPicker-alpha"><div class="colorPicker-alpha-bar"><span class="colorPicker-alpha-indicator"></span></div></div></div>');
