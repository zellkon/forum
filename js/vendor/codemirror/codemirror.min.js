...
a.slice(0,c.ch));e==b.line&&(a=a.slice(b.ch));d.push(a);++e});return d}function Tc(a,b,c){var d=[];a.iter(b,c,function(a){d.push(a.text)});return d}function qa(a,b){if(b-=a.height)for(;a;a=a.parent)a.height+=b}function C(a){if(null==a.parent)return null;var b=a.parent;a=P(b.lines,a);for(var c=b.parent;c;b=c,c=c.parent)for(var d=0;c.children[d]!=b;++d)a+=c.children[d].chunkSize();return a+b.first}function Ka(a,b){var c=a.first;a:do{for(var d=0;d<a.children.length;++d){var e=a.children[d],f=e.height;
...
J(a,c||b.type,a,b);return ad(b)||b.codemirrorIgnore}function ge(a){var b=a._handlers&&a._handlers.cursorActivity;if(b){a=a.curOp.cursorActivityHandlers||(a.curOp.cursorActivityHandlers=[]);for(var c=0;c<b.length;++c)-1==P(a,b[c])&&a.push(b[c])}}function ja(a,b){return 0<(a._handlers&&a._handlers[b]||nc).length}function bb(a){a.prototype.on=function(a,c){w(this,a,c)};a.prototype.off=function(a,c){ea(this,a,c)}}function Y(a){a.preventDefault?a.preventDefault():a.returnValue=!1}function he(a){a.stopPropagation?
...
a.curOp||a.display.selForContextMenu==a.doc.sel||(a.display.input.reset(),T&&setTimeout(function(){return a.display.input.reset(!0)},20)),a.display.input.receivedFocus()),vd(a))}function Gb(a,b){a.state.delayingBlurEvent||(a.state.focused&&(J(a,"blur",a,b),a.state.focused=!1,Ua(a.display.wrapper,"CodeMirror-focused")),clearInterval(a.display.blinker),setTimeout(function(){a.state.focused||(a.display.shift=!1)},150))}function vc(a){a=a.display;for(var b=a.lineDiv.offsetTop,c=0;c<a.view.length;c++){var d=
...
d.changeObjs&&J(e,"changes",e,d.changeObjs);d.update&&d.update.finish()}})}function ca(a,b){if(a.curOp)return b();Wa(a);try{return b()}finally{Xa(a)}}function N(a,b){return function(){if(a.curOp)return b.apply(a,arguments);Wa(a);try{return b.apply(a,arguments)}finally{Xa(a)}}}function W(a){return function(){if(this.curOp)return a.apply(this,arguments);Wa(this);try{return a.apply(this,arguments)}finally{Xa(this)}}}function O(a){return function(){var b=this.cm;if(!b||b.curOp)return a.apply(this,arguments);
...
Kb(a);Fb(a);gb(a,c);Cd(a,c);b.finish()}}function Ig(a,b,c){function d(b){var d=b.nextSibling;T&&la&&a.display.currentWheelTarget==b?b.style.display="none":b.parentNode.removeChild(b);return d}var e=a.display,f=a.options.lineNumbers,g=e.lineDiv,h=g.firstChild,k=e.view;e=e.viewFrom;for(var l=0;l<k.length;l++){var m=k[l];if(!m.hidden)if(m.node&&m.node.parentNode==g){for(;h!=m.node;)h=d(h);h=f&&null!=b&&b<=e&&m.lineNumber;m.changes&&(-1<P(m.changes,"gutter")&&(h=!1),ve(a,m,e,c));h&&(I(m.lineNumber),m.lineNumber.appendChild(document.createTextNode(Uc(a.options,
...
e));"CodeMirror-linenumbers"==e&&(a.display.lineGutter=f,f.style.width=(a.display.lineNumWidth||1)+"px")}b.style.display=d?"":"none";yd(a)}function Dd(a){var b=P(a.gutters,"CodeMirror-linenumbers");-1==b&&a.lineNumbers?a.gutters=a.gutters.concat(["CodeMirror-linenumbers"]):-1<b&&!a.lineNumbers&&(a.gutters=a.gutters.slice(0),a.gutters.splice(b,1))}function bf(a){var b=a.wheelDeltaX,c=a.wheelDeltaY;null==b&&a.detail&&a.axis==a.HORIZONTAL_AXIS&&(b=a.detail);null==c&&a.detail&&a.axis==a.VERTICAL_AXIS?
c=a.detail:null==c&&(c=a.wheelDelta);return{x:b,y:c}}function Jg(a){a=bf(a);a.x*=fa;a.y*=fa;return a}function cf(a,b){var c=bf(b),d=c.x;c=c.y;var e=a.display,f=e.scroller,g=f.scrollWidth>f.clientWidth,h=f.scrollHeight>f.clientHeight;if(d&&g||c&&h){if(c&&la&&T){g=b.target;var k=e.view;a:for(;g!=f;g=g.parentNode)for(var l=0;l<k.length;l++)if(k[l].node==g){a.display.currentWheelTarget=g;break a}}!d||Aa||oa||null==fa?(c&&null!=fa&&(b=c*fa,h=a.doc.scrollTop,g=h+e.wrapper.clientHeight,0>b?h=Math.max(0,
...
k[0],c?c[0]:null),a.insert(g.line+1,r)):1==k.length?(e(l,l.text.slice(0,g.ch)+k[0]+m.text.slice(h.ch),c?c[0]:null),a.remove(g.line+1,r)):(e(l,l.text.slice(0,g.ch)+k[0],c?c[0]:null),e(m,p+m.text.slice(h.ch),n),n=f(1,k.length-1),1<r&&a.remove(g.line+1,r-1),a.insert(g.line+1,n));R(a,"change",a,b)}function Ya(a,b,c){function d(a,f,g){if(a.linked)for(var e=0;e<a.linked.length;++e){var k=a.linked[e];if(k.doc!=f){var l=g&&k.sharedHist;if(!c||l)b(k.doc,l),d(k.doc,a,l)}}}d(a,null,!0)}function gf(a,b){if(b.cm)throw Error("This document is already in use.");
...
m.match(/^spans_(\d+)$/))&&-1<P(b,Number(l[1]))&&(y(g)[m]=k[m],delete k[m])}}}return d}function Id(a,b,c,d){return d?(a=a.anchor,c&&(d=0>x(b,a),d!=0>x(c,a)?(a=b,b=c):d!=0>x(b,c)&&(b=c)),new A(a,b)):new A(c||b,b)}function Dc(a,b,c,d,e){null==e&&(e=a.cm&&(a.cm.display.shift||a.extend));S(a,new ha([Id(a.sel.primary(),b,c,e)],0),d)}function nf(a,b,c){for(var d=[],e=a.cm&&(a.cm.display.shift||a.extend),f=0;f<a.sel.ranges.length;f++)d[f]=Id(a.sel.ranges[f],b[f],null,e);b=pa(d,a.sel.primIndex);S(a,b,c)}
function Jd(a,b,c,d){var e=a.sel.ranges.slice(0);e[b]=c;S(a,pa(e,a.sel.primIndex),d)}function Mg(a,b,c){c={ranges:b.ranges,update:function(b){this.ranges=[];for(var d=0;d<b.length;d++)this.ranges[d]=new A(v(a,b[d].anchor),v(a,b[d].head))},origin:c&&c.origin};J(a,"beforeSelectionChange",a,c);a.cm&&J(a.cm,"beforeSelectionChange",a.cm,c);return c.ranges!=b.ranges?pa(c.ranges,c.ranges.length-1):b}function of(a,b,c){var d=a.history.done,e=y(d);e&&e.ranges?(d[d.length-1]=b,Ec(a,b,c)):S(a,b,c)}function S(a,
...
J(a.cm,"beforeChange",a.cm,d);return d.canceled?null:{from:d.from,to:d.to,text:d.text,origin:d.origin}}function kb(a,b,c){if(a.cm){if(!a.cm.curOp)return N(a.cm,kb)(a,b,c);if(a.cm.state.suppressEdits)return}if(ja(a,"beforeChange")||a.cm&&ja(a.cm,"beforeChange"))if(b=uf(a,b,!0),!b)return;if(c=vf&&!c&&lg(a,b.from,b.to))for(var d=c.length-1;0<=d;--d)wf(a,{from:c[d].from,to:c[d].to,text:d?[""]:b.text,origin:b.origin});else wf(a,b)}function wf(a,b){if(1!=b.text.length||""!=b.text[0]||0!=x(b.from,b.to)){var c=
Ed(a,b);lf(a,b,c,a.cm?a.cm.curOp.id:NaN);Mb(a,b,c,Xc(a,b));var d=[];Ya(a,function(a,c){c||-1!=P(d,a.history)||(xf(a.history,b),d.push(a.history));Mb(a,b,null,Xc(a,b))})}}function Fc(a,b,c){var d=a.cm&&a.cm.state.suppressEdits;if(!d||c){for(var e=a.history,f,g=a.sel,h="undo"==b?e.done:e.undone,k="undo"==b?e.undone:e.done,l=0;l<h.length&&(f=h[l],c?!f.ranges||f.equals(a.sel):f.ranges);l++);if(l!=h.length){for(e.lastOrigin=e.lastSelOrigin=null;;)if(f=h.pop(),f.ranges){Cc(f,k);if(c&&!f.equals(a.sel)){S(a,
f,{clearRedo:!1});return}g=f}else{if(d){h.push(f);return}break}var m=[];Cc(g,k);k.push({changes:m,generation:e.generation});e.generation=f.generation||++e.maxGeneration;var p=ja(a,"beforeChange")||a.cm&&ja(a.cm,"beforeChange");c=function(d){var c=f.changes[d];c.origin=b;if(p&&!uf(a,c,!1))return h.length=0,{};m.push(Hd(a,c));var e=d?Ed(a,c):y(h);Mb(a,c,e,mf(a,c));!d&&a.cm&&a.cm.scrollIntoView({from:c.from,to:Ea(c)});var g=[];Ya(a,function(a,b){b||-1!=P(g,a.history)||(xf(a.history,c),g.push(a.history));
Mb(a,c,null,mf(a,c))})};for(d=f.changes.length-1;0<=d;--d)if(e=c(d))return e.v}}}function yf(a,b){if(0!=b&&(a.first+=b,a.sel=new ha(hc(a.sel.ranges,function(a){return new A(q(a.anchor.line+b,a.anchor.ch),q(a.head.line+b,a.head.ch))}),a.sel.primIndex),a.cm)){Z(a.cm,a.first,a.first-b,b);for(var c=a.cm.display,d=c.viewFrom;d<c.viewTo;d++)Da(a.cm,d,"gutter")}}function Mb(a,b,c,d){if(a.cm&&!a.cm.curOp)return N(a.cm,Mb)(a,b,c,d);if(b.to.line<a.first)yf(a,b.text.length-1-(b.to.line-b.from.line));else if(!(b.from.line>
...
f.css)for(d=b.line;d<=c.line;d++)Da(h,d,"text");f.atomic&&rf(h.doc);R(h,"markerAdded",h,f)}return f}function Pg(a,b,c,d,e){d=Ia(d);d.shared=!1;var f=[mb(a,b,c,d,e)],g=f[0],h=d.widgetNode;Ya(a,function(a){h&&(d.widgetNode=h.cloneNode(!0));f.push(mb(a,v(a,b),v(a,c),d,e));for(var k=0;k<a.linked.length;++k)if(a.linked[k].isParent)return;g=y(f)});return new Rb(f,g)}function Cf(a){return a.findMarks(q(a.first,0),a.clipPos(q(a.lastLine())),function(a){return a.parent})}function Qg(a){for(var b=function(b){b=
a[b];var d=[b.primary.doc];Ya(b.primary.doc,function(a){return d.push(a)});for(var c=0;c<b.markers.length;c++){var g=b.markers[c];-1==P(d,g.doc)&&(g.parent=null,b.markers.splice(c--,1))}},c=0;c<a.length;c++)b(c)}function Rg(a){var b=this;Df(b);if(!M(b,a)&&!ya(b.display,a)){Y(a);B&&(Ef=+new Date);var c=Ta(b,a,!0),d=a.dataTransfer.files;if(c&&!b.isReadOnly())if(d&&d.length&&window.FileReader&&window.File)for(var e=d.length,f=Array(e),g=0,h=function(a,d){if(!b.options.allowDropFileTypes||-1!=P(b.options.allowDropFileTypes,
a.type)){var h=new FileReader;h.onload=N(b,function(){var a=h.result;/[\x00-\x08\x0e-\x1f]{2}/.test(a)&&(a="");f[d]=a;++g==e&&(c=v(b.doc,c),a={from:c,to:c,text:b.doc.splitLines(f.join(b.doc.lineSeparator())),origin:"paste"},kb(b.doc,a),of(b.doc,za(c,Ea(a))))});h.readAsText(a)}},k=0;k<e;++k)h(d[k],k);else if(b.state.draggingText&&-1<b.doc.sel.contains(c))b.state.draggingText(a),setTimeout(function(){return b.display.input.focus()},20);else try{if(h=a.dataTransfer.getData("Text")){b.state.draggingText&&
!b.state.draggingText.copy&&(k=b.listSelections());Ec(b.doc,za(c,c));if(k)for(d=0;d<k.length;++d)lb(b.doc,"",k[d].anchor,k[d].head,"drag");b.replaceSelection(h,"around","paste");b.display.input.focus()}}catch(l){}}}function Df(a){a.display.dragCursor&&(a.display.lineSpace.removeChild(a.display.dragCursor),a.display.dragCursor=null)}function Ff(a){if(document.getElementsByClassName)for(var b=document.getElementsByClassName("CodeMirror"),c=0;c<b.length;c++){var d=b[c].CodeMirror;d&&a(d)}}function Sg(){var a;
...
!0;else if(/^(c|ctrl|control)$/i.test(h))d=!0;else if(/^s(hift)?$/i.test(h))e=!0;else throw Error("Unrecognized modifier name: "+h);}c&&(a="Alt-"+a);d&&(a="Ctrl-"+a);f&&(a="Cmd-"+a);e&&(a="Shift-"+a);return a}function Vg(a){var b={},c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];if(!/^(name|fallthrough|(de|at)tach)$/.test(c)){if("..."!=d)for(var e=hc(c.split(" "),Ug),f=0;f<e.length;f++){if(f==e.length-1){var g=e.join(" ");var h=d}else g=e.slice(0,f+1).join(" "),h="...";var k=b[g];if(!k)b[g]=h;else if(k!=
h)throw Error("Inconsistent bindings for "+g);}delete a[c]}}for(var l in b)a[l]=b[l];return a}function nb(a,b,c,d){b=Gc(b);var e=b.call?b.call(a,d):b[a];if(!1===e)return"nothing";if("..."===e)return"multi";if(null!=e&&c(e))return"handled";if(b.fallthrough){if("[object Array]"!=Object.prototype.toString.call(b.fallthrough))return nb(a,b.fallthrough,c,d);for(e=0;e<b.fallthrough.length;e++){var f=nb(a,b.fallthrough[e],c,d);if(f)return f}}}function Gf(a){a="string"==typeof a?a:Ga[a.keyCode];return"Ctrl"==
a||"Alt"==a||"Shift"==a||"Mod"==a}function Hf(a,b,c){var d=a;b.altKey&&"Alt"!=d&&(a="Alt-"+a);(If?b.metaKey:b.ctrlKey)&&"Ctrl"!=d&&(a="Ctrl-"+a);(If?b.ctrlKey:b.metaKey)&&"Cmd"!=d&&(a="Cmd-"+a);!c&&b.shiftKey&&"Shift"!=d&&(a="Shift-"+a);return a}function Jf(a,b){if(oa&&34==a.keyCode&&a["char"])return!1;var c=Ga[a.keyCode];if(null==c||a.altGraphKey)return!1;3==a.keyCode&&a.code&&(c=a.code);return Hf(c,a,b)}function Gc(a){return"string"==typeof a?Sb[a]:a}function ob(a,b){for(var c=a.doc.sel.ranges,
d=[],e=0;e<c.length;e++){for(var f=b(c[e]);d.length&&0>=x(f.from,y(d).to);){var g=d.pop();if(0>x(g.from,f.from)){f.from=g.from;break}}d.push(f)}ca(a,function(){for(var b=d.length-1;0<=b;b--)lb(a.doc,"",d[b].from,d[b].to,"+delete");fb(a)})}function Ld(a,b,c){b=Zd(a.text,b+c,c);return 0>b||b>a.text.length?null:b}function Md(a,b,c){a=Ld(a,b.ch,c);return null==a?null:new q(b.line,a,0>c?"after":"before")}function Nd(a,b,c,d,e){if(a&&(a=xa(c,b.doc.direction))){a=0>e?y(a):a[0];var f=0>e==(1==a.level)?"after":
"before";if(0<a.level||"rtl"==b.doc.direction){var g=Qa(b,c);var h=0>e?c.text.length-1:0;var k=ma(b,g,h).top;h=rb(function(a){return ma(b,g,a).top==k},0>e==(1==a.level)?a.from:a.to-1,h);"before"==f&&(h=Ld(c,h,1))}else h=0>e?a.to:a.from;return new q(d,h,f)}return new q(d,0>e?c.text.length:0,0>e?"before":"after")}function Wg(a,b,c,d){var e=xa(b,a.doc.direction);if(!e)return Md(b,c,d);c.ch>=b.text.length?(c.ch=b.text.length,c.sticky="before"):0>=c.ch&&(c.ch=0,c.sticky="after");var f=vb(e,c.ch,c.sticky),
g=e[f];if("ltr"==a.doc.direction&&0==g.level%2&&(0<d?g.to>c.ch:g.from<c.ch))return Md(b,c,d);var h=function(a,d){return Ld(b,a instanceof q?a.ch:a,d)},k,l=function(d){if(!a.options.lineWrapping)return{begin:0,end:b.text.length};k=k||Qa(a,b);return Le(a,b,k,d)},m=l("before"==c.sticky?h(c,-1):c.ch);if("rtl"==a.doc.direction||1==g.level){var p=1==g.level==0>d,n=h(c,p?1:-1);if(null!=n&&(p?n<=g.to&&n<=m.end:n>=g.from&&n>=m.begin))return new q(c.line,n,p?"before":"after")}g=function(a,b,d){for(var f=function(a,
b){return b?new q(c.line,h(a,1),"before"):new q(c.line,a,"after")};0<=a&&a<e.length;a+=b){var g=e[a],k=0<b==(1!=g.level),l=k?d.begin:h(d.end,-1);if(g.from<=l&&l<g.to)return f(l,k);l=k?g.from:h(g.to,-1);if(d.begin<=l&&l<d.end)return f(l,k)}};if(f=g(f+d,d,m))return f;m=0<d?m.end:h(m.begin,-1);return null==m||0<d&&m==b.text.length||!(f=g(0<d?0:e.length-1,d,l(m)))?null:f}function Kf(a,b){var c=t(a.doc,b),d=ra(c);d!=c&&(b=C(d));return Nd(!0,a,d,b,1)}function Lf(a,b){var c=Kf(a,b.line),d=t(a.doc,c.line);
...
null:Xg.set(50,function(){a.state.keySeq==e&&(a.state.keySeq=null,a.display.input.reset())});if(Mf(a,e+" "+b,c,d))return!0}return Mf(a,b,c,d)}function Mf(a,b,c,d){a:{for(var e=0;e<a.state.keyMaps.length;e++){var f=nb(b,a.state.keyMaps[e],d,a);if(f){d=f;break a}}d=a.options.extraKeys&&nb(b,a.options.extraKeys,d,a)||nb(b,a.options.keyMap,d,a)}"multi"==d&&(a.state.keySeq=b);"handled"==d&&R(a,"keyHandled",a,b,c);if("handled"==d||"multi"==d)Y(c),vd(a);return!!d}function Nf(a,b){var c=Jf(b,!0);return c?
b.shiftKey&&!a.state.keySeq?Ub(a,"Shift-"+c,b,function(b){return Hc(a,b,!0)})||Ub(a,c,b,function(b){if("string"==typeof b?/^go[A-Z]/.test(b):b.motion)return Hc(a,b)}):Ub(a,c,b,function(b){return Hc(a,b)}):!1}function Yg(a,b,c){return Ub(a,"'"+c+"'",b,function(b){return Hc(a,b,!0)})}function Of(a){this.curOp.focus=wa();if(!M(this,a)){B&&11>F&&27==a.keyCode&&(a.returnValue=!1);var b=a.keyCode;this.display.shift=16==b||a.shiftKey;var c=Nf(this,a);oa&&(Od=c?b:null,!c&&88==b&&!Zg&&(la?a.metaKey:a.ctrlKey)&&
this.replaceSelection("",null,"cut"));18!=b||/\bCodeMirror-crosshair\b/.test(this.display.lineDiv.className)||$g(this)}}function $g(a){function b(a){18!=a.keyCode&&a.altKey||(Ua(c,"CodeMirror-crosshair"),ea(document,"keyup",b),ea(document,"mouseover",b))}var c=a.display.lineDiv;Ha(c,"CodeMirror-crosshair");w(document,"keyup",b);w(document,"mouseover",b)}function Pf(a){16==a.keyCode&&(this.doc.sel.shift=!1);M(this,a)}function Qf(a){if(!(ya(this.display,a)||M(this,a)||a.ctrlKey&&!a.altKey||la&&a.metaKey)){var b=
a.keyCode,c=a.charCode;if(oa&&b==Od)Od=null,Y(a);else if(!oa||a.which&&!(10>a.which)||!Nf(this,a))if(b=String.fromCharCode(null==c?b:c),"\b"!=b&&!Yg(this,a,b))this.display.input.onKeyPress(a)}}function ah(a,b){var c=+new Date;if(Vb&&Vb.compare(c,a,b))return Wb=Vb=null,"triple";if(Wb&&Wb.compare(c,a,b))return Vb=new Pd(c,a,b),Wb=null,"double";Wb=new Pd(c,a,b);Vb=null;return"single"}function Rf(a){var b=this.display;if(!(M(this,a)||b.activeTouch&&b.input.supportsTouch()))if(b.input.ensurePolled(),b.shift=
a.shiftKey,ya(b,a))T||(b.scroller.draggable=!1,setTimeout(function(){return b.scroller.draggable=!0},100));else if(!Jc(this,a,"gutterClick",!0)){var c=Ta(this,a),d=ie(a),e=c?ah(c,d):"single";window.focus();1==d&&this.state.selectingText&&this.state.selectingText(a);c&&bh(this,d,c,e,a)||(1==d?c?ch(this,c,e,a):(a.target||a.srcElement)==b.scroller&&Y(a):2==d?(c&&Dc(this.doc,c),setTimeout(function(){return b.input.focus()},20)):3==d&&(Qd?Sf(this,a):Qe(this)))}}function bh(a,b,c,d,e){var f="Click";"double"==
...
if(null==e.extend||a.doc.extend)e.extend=a.doc.extend||d.shiftKey;null==e.addNew&&(e.addNew=la?d.metaKey:d.ctrlKey);null==e.moveOnDrag&&(e.moveOnDrag=!(la?d.altKey:d.ctrlKey));var f=a.doc.sel,g;a.options.dragDrop&&eh&&!a.isReadOnly()&&"single"==c&&-1<(g=f.contains(b))&&(0>x((g=f.ranges[g]).from(),b)||0<b.xRel)&&(0<x(g.to(),b)||0>b.xRel)?fh(a,d,b,e):gh(a,d,b,e)}function fh(a,b,c,d){var e=a.display,f=!1,g=N(a,function(b){T&&(e.scroller.draggable=!1);a.state.draggingText=!1;ea(document,"mouseup",g);
ea(document,"mousemove",h);ea(e.scroller,"dragstart",k);ea(e.scroller,"drop",g);f||(Y(b),d.addNew||Dc(a.doc,c,null,null,d.extend),T||B&&9==F?setTimeout(function(){document.body.focus();e.input.focus()},20):e.input.focus())}),h=function(a){f=f||10<=Math.abs(b.clientX-a.clientX)+Math.abs(b.clientY-a.clientY)},k=function(){return f=!0};T&&(e.scroller.draggable=!0);a.state.draggingText=g;g.copy=!d.moveOnDrag;e.scroller.dragDrop&&e.scroller.dragDrop();w(document,"mouseup",g);w(document,"mousemove",h);
w(e.scroller,"dragstart",k);w(e.scroller,"drop",g);Qe(a);setTimeout(function(){return e.input.focus()},20)}function Tf(a,b,c){if("char"==c)return new A(b,b);if("word"==c)return a.findWordAt(b);if("line"==c)return new A(q(b.line,0),v(a.doc,q(b.line+1,0)));a=c(a,b);return new A(a.from,a.to)}function gh(a,b,c,d){function e(b){if(0!=x(r,b))if(r=b,"rectangle"==d.unit){var e=[],f=a.options.tabSize,g=ia(t(k,c.line).text,c.ch,f),h=ia(t(k,b.line).text,b.ch,f),m=Math.min(g,h);g=Math.max(g,h);h=Math.min(c.line,
b.line);for(var u=Math.min(a.lastLine(),Math.max(c.line,b.line));h<=u;h++){var w=t(k,h).text,U=Pc(w,m,f);m==g?e.push(new A(q(h,U),q(h,U))):w.length>U&&e.push(new A(q(h,U),q(h,Pc(w,g,f))))}e.length||e.push(new A(c,c));S(k,pa(l.ranges.slice(0,p).concat(e),p),{origin:"*mouse",scroll:!1});a.scrollIntoView(b)}else e=n,m=Tf(a,b,d.unit),b=e.anchor,0<x(m.anchor,b)?(f=m.head,b=kc(e.from(),m.anchor)):(f=m.anchor,b=jc(e.to(),m.head)),e=l.ranges.slice(0),e[p]=hh(a,new A(v(k,b),f)),S(k,pa(e,p),Rd)}function f(b){var c=
++y,g=Ta(a,b,!0,"rectangle"==d.unit);if(g)if(0!=x(g,r)){a.curOp.focus=wa();e(g);var l=xd(h,k);(g.line>=l.to||g.line<l.from)&&setTimeout(N(a,function(){y==c&&f(b)}),150)}else{var m=b.clientY<u.top?-20:b.clientY>u.bottom?20:0;m&&setTimeout(N(a,function(){y==c&&(h.scroller.scrollTop+=m,f(b))}),50)}}function g(b){a.state.selectingText=!1;y=Infinity;Y(b);h.input.focus();ea(document,"mousemove",z);ea(document,"mouseup",B);k.history.lastSelOrigin=null}var h=a.display,k=a.doc;Y(b);var l=k.sel,m=l.ranges;
if(d.addNew&&!d.extend){var p=k.sel.contains(c);var n=-1<p?m[p]:new A(c,c)}else n=k.sel.primary(),p=k.sel.primIndex;"rectangle"==d.unit?(d.addNew||(n=new A(c,c)),c=Ta(a,b,!0,!0),p=-1):(b=Tf(a,c,d.unit),n=d.extend?Id(n,b.anchor,b.head,d.extend):b);d.addNew?-1==p?(p=m.length,S(k,pa(m.concat([n]),p),{scroll:!1,origin:"*mouse"})):1<m.length&&m[p].empty()&&"char"==d.unit&&!d.extend?(S(k,pa(m.slice(0,p).concat(m.slice(p+1)),0),{scroll:!1,origin:"*mouse"}),l=k.sel):Jd(k,p,n,Rd):(p=0,S(k,new ha([n],0),Rd),
l=k.sel);var r=c,u=h.wrapper.getBoundingClientRect(),y=0,z=N(a,function(a){ie(a)?f(a):g(a)}),B=N(a,g);a.state.selectingText=B;w(document,"mousemove",z);w(document,"mouseup",B)}function hh(a,b){var c=b.anchor,d=b.head,e=t(a.doc,c.line);if(0==x(c,d)&&c.sticky==d.sticky)return b;e=xa(e);if(!e)return b;var f=vb(e,c.ch,c.sticky),g=e[f];if(g.from!=c.ch&&g.to!=c.ch)return b;var h=f+(g.from==c.ch==(1!=g.level)?0:1);if(0==h||h==e.length)return b;d.line!=c.line?a=0<(d.line-c.line)*("ltr"==a.doc.direction?1:
-1):(a=vb(e,d.ch,d.sticky),f=a-f||(d.ch-c.ch)*(1==g.level?-1:1),a=a==h-1||a==h?0>f:0<f);e=e[h+(a?-1:0)];e=(h=a==(1==e.level))?e.from:e.to;h=h?"after":"before";return c.ch==e&&c.sticky==h?b:new A(new q(c.line,e,h),d)}function Jc(a,b,c,d){if(b.touches){var e=b.touches[0].clientX;var f=b.touches[0].clientY}else try{e=b.clientX,f=b.clientY}catch(k){return!1}if(e>=Math.floor(a.display.gutters.getBoundingClientRect().right))return!1;d&&Y(b);d=a.display;var g=d.lineDiv.getBoundingClientRect();if(f>g.bottom||
!ja(a,c))return ad(b);f-=g.top-d.viewOffset;for(g=0;g<a.options.gutters.length;++g){var h=d.gutters.childNodes[g];if(h&&h.getBoundingClientRect().right>=e)return e=Ka(a.doc,f),J(a,c,a,e,a.options.gutters[g],b),ad(b)}}function Sf(a,b){var c;(c=ya(a.display,b))||(c=ja(a,"gutterContextMenu")?Jc(a,b,"gutterContextMenu",!1):!1);if(!c&&!M(a,b,"contextmenu"))a.display.input.onContextMenu(b)}function Uf(a){a.display.wrapper.className=a.display.wrapper.className.replace(/\s*cm-s-\S+/g,"")+a.options.theme.replace(/(^|\s)\s*/g,
" cm-s-");Eb(a)}function Xb(a){af(a);Z(a);Se(a)}function ih(a,b,c){!b!=!(c&&c!=pb)&&(c=a.display.dragFunctions,b=b?w:ea,b(a.display.scroller,"dragstart",c.start),b(a.display.scroller,"dragenter",c.enter),b(a.display.scroller,"dragover",c.over),b(a.display.scroller,"dragleave",c.leave),b(a.display.scroller,"drop",c.drop))}function jh(a){a.options.lineWrapping?(Ha(a.display.wrapper,"CodeMirror-wrap"),a.display.sizer.style.minWidth="",a.display.sizerWidth=null):(Ua(a.display.wrapper,"CodeMirror-wrap"),
$c(a));ud(a);Z(a);Eb(a);setTimeout(function(){return gb(a)},100)}function G(a,b){var c=this;if(!(this instanceof G))return new G(a,b);this.options=b=b?Ia(b):{};Ia(Vf,b,!1);Dd(b);var d=b.value;"string"==typeof d&&(d=new aa(d,b.mode,null,b.lineSeparator,b.direction));this.doc=d;var e=new G.inputStyles[b.inputStyle](this);a=this.display=new kg(a,d,e);a.wrapper.CodeMirror=this;af(this);Uf(this);b.lineWrapping&&(this.display.wrapper.className+=" CodeMirror-wrap");Xe(this);this.state={keyMaps:[],overlays:[],
modeGen:0,overwrite:!1,delayingBlurEvent:!1,focused:!1,suppressEdits:!1,pasteIncoming:!1,cutIncoming:!1,selectingText:!1,draggingText:!1,highlight:new Za,keySeq:null,specialChars:null};b.autofocus&&!sb&&a.input.focus();B&&11>F&&setTimeout(function(){return c.display.input.reset(!0)},20);kh(this);Wf||(Sg(),Wf=!0);Wa(this);this.curOp.forceUpdate=!0;gf(this,d);b.autofocus&&!sb||this.hasFocus()?setTimeout(Oc(wd,this),20):Gb(this);for(var f in Kc)if(Kc.hasOwnProperty(f))Kc[f](c,b[f],pb);Te(this);b.finishInit&&
b.finishInit(this);for(d=0;d<Sd.length;++d)Sd[d](c);Xa(this);T&&b.lineWrapping&&"optimizelegibility"==getComputedStyle(a.lineDiv).textRendering&&(a.lineDiv.style.textRendering="auto")}function kh(a){function b(){d.activeTouch&&(e=setTimeout(function(){return d.activeTouch=null},1E3),f=d.activeTouch,f.end=+new Date)}function c(a,b){if(null==b.left)return!0;var d=b.left-a.left;a=b.top-a.top;return 400<d*d+a*a}var d=a.display;w(d.scroller,"mousedown",N(a,Rf));B&&11>F?w(d.scroller,"dblclick",N(a,function(b){if(!M(a,
b)){var d=Ta(a,b);!d||Jc(a,b,"gutterClick",!0)||ya(a.display,b)||(Y(b),b=a.findWordAt(d),Dc(a.doc,b.anchor,b.head))}})):w(d.scroller,"dblclick",function(b){return M(a,b)||Y(b)});Qd||w(d.scroller,"contextmenu",function(b){return Sf(a,b)});var e,f={end:0};w(d.scroller,"touchstart",function(b){var c;if(c=!M(a,b))1!=b.touches.length?c=!1:(c=b.touches[0],c=1>=c.radiusX&&1>=c.radiusY),c=!c;c&&!Jc(a,b,"gutterClick",!0)&&(d.input.ensurePolled(),clearTimeout(e),c=+new Date,d.activeTouch={start:c,moved:!1,
prev:300>=c-f.end?f:null},1==b.touches.length&&(d.activeTouch.left=b.touches[0].pageX,d.activeTouch.top=b.touches[0].pageY))});w(d.scroller,"touchmove",function(){d.activeTouch&&(d.activeTouch.moved=!0)});w(d.scroller,"touchend",function(e){var f=d.activeTouch;if(f&&!ya(d,e)&&null!=f.left&&!f.moved&&300>new Date-f.start){var g=a.coordsChar(d.activeTouch,"page");f=!f.prev||c(f,f.prev)?new A(g,g):!f.prev.prev||c(f,f.prev.prev)?a.findWordAt(g):new A(q(g.line,0),v(a.doc,q(g.line+1,0)));a.setSelection(f.anchor,
f.head);a.focus();Y(e)}b()});w(d.scroller,"touchcancel",b);w(d.scroller,"scroll",function(){d.scroller.clientHeight&&(Ib(a,d.scroller.scrollTop),Va(a,d.scroller.scrollLeft,!0),J(a,"scroll",a))});w(d.scroller,"mousewheel",function(b){return cf(a,b)});w(d.scroller,"DOMMouseScroll",function(b){return cf(a,b)});w(d.wrapper,"scroll",function(){return d.wrapper.scrollTop=d.wrapper.scrollLeft=0});d.dragFunctions={enter:function(b){M(a,b)||xb(b)},over:function(b){if(!M(a,b)){var d=Ta(a,b);if(d){var c=document.createDocumentFragment();
Oe(a,d,c);a.display.dragCursor||(a.display.dragCursor=u("div",null,"CodeMirror-cursors CodeMirror-dragcursors"),a.display.lineSpace.insertBefore(a.display.dragCursor,a.display.cursorDiv));E(a.display.dragCursor,c)}xb(b)}},start:function(b){if(B&&(!a.state.draggingText||100>+new Date-Ef))xb(b);else if(!M(a,b)&&!ya(a.display,b)&&(b.dataTransfer.setData("Text",a.getSelection()),b.dataTransfer.effectAllowed="copyMove",b.dataTransfer.setDragImage&&!Xf)){var d=u("img",null,null,"position: fixed; left: 0; top: 0;");
d.src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";oa&&(d.width=d.height=1,a.display.wrapper.appendChild(d),d._top=d.offsetTop);b.dataTransfer.setDragImage(d,0,0);oa&&d.parentNode.removeChild(d)}},drop:N(a,Rg),leave:function(b){M(a,b)||Df(a)}};var g=d.input.getField();w(g,"keyup",function(b){return Pf.call(a,b)});w(g,"keydown",N(a,Of));w(g,"keypress",N(a,Qf));w(g,"focus",function(b){return wd(a,b)});w(g,"blur",function(b){return Gb(a,b)})}function Yb(a,b,c,d){var e=
a.doc,f;null==c&&(c="add");"smart"==c&&(e.mode.indent?f=yb(a,b).state:c="prev");var g=a.options.tabSize,h=t(e,b),k=ia(h.text,null,g);h.stateAfter&&(h.stateAfter=null);var l=h.text.match(/^\s*/)[0];if(!d&&!/\S/.test(h.text)){var m=0;c="not"}else if("smart"==c&&(m=e.mode.indent(f,h.text.slice(l.length),h.text),m==Ic||150<m)){if(!d)return;c="prev"}"prev"==c?m=b>e.first?ia(t(e,b-1).text,null,g):0:"add"==c?m=k+a.options.indentUnit:"subtract"==c?m=k-a.options.indentUnit:"number"==typeof c&&(m=k+c);m=Math.max(0,
m);c="";d=0;if(a.options.indentWithTabs)for(a=Math.floor(m/g);a;--a)d+=g,c+="\t";d<m&&(c+=Qc(m-d));if(c!=l)return lb(e,c,q(b,0),q(b,l.length),"+input"),h.stateAfter=null,!0;for(g=0;g<e.sel.ranges.length;g++)if(h=e.sel.ranges[g],h.head.line==b&&h.head.ch<l.length){b=q(b,l.length);Jd(e,g,new A(b,b));break}}function Td(a,b,c,d,e){var f=a.doc;a.display.shift=!1;d||(d=f.sel);var g=a.state.pasteIncoming||"paste"==e,h=Ud(b),k=null;if(g&&1<d.ranges.length)if(da&&da.text.join("\n")==b){if(0==d.ranges.length%
da.text.length){k=[];for(var l=0;l<da.text.length;l++)k.push(f.splitLines(da.text[l]))}}else h.length==d.ranges.length&&a.options.pasteLinesPerSelection&&(k=hc(h,function(a){return[a]}));for(l=d.ranges.length-1;0<=l;l--){var m=d.ranges[l];var p=m.from(),n=m.to();m.empty()&&(c&&0<c?p=q(p.line,p.ch-c):a.state.overwrite&&!g?n=q(n.line,Math.min(t(f,n.line).text.length,n.ch+y(h).length)):da&&da.lineWise&&da.text.join("\n")==b&&(p=n=q(p.line,0)));m=a.curOp.updateInput;p={from:p,to:n,text:k?k[l%k.length]:
h,origin:e||(g?"paste":a.state.cutIncoming?"cut":"+input")};kb(a.doc,p);R(a,"inputRead",a,p)}b&&!g&&Yf(a,b);fb(a);a.curOp.updateInput=m;a.curOp.typing=!0;a.state.pasteIncoming=a.state.cutIncoming=!1}function Zf(a,b){var c=a.clipboardData&&a.clipboardData.getData("Text");if(c)return a.preventDefault(),b.isReadOnly()||b.options.disableInput||ca(b,function(){return Td(b,c,0,null,"paste")}),!0}function Yf(a,b){if(a.options.electricChars&&a.options.smartIndent)for(var c=a.doc.sel,d=c.ranges.length-1;0<=
d;d--){var e=c.ranges[d];if(!(100<e.head.ch||d&&c.ranges[d-1].head.line==e.head.line)){var f=a.getModeAt(e.head),g=!1;if(f.electricChars)for(var h=0;h<f.electricChars.length;h++){if(-1<b.indexOf(f.electricChars.charAt(h))){g=Yb(a,e.head.line,"smart");break}}else f.electricInput&&f.electricInput.test(t(a.doc,e.head.line).text.slice(0,e.head.ch))&&(g=Yb(a,e.head.line,"smart"));g&&R(a,"electricInput",a,e.head.line)}}}function $f(a){for(var b=[],c=[],d=0;d<a.doc.sel.ranges.length;d++){var e=a.doc.sel.ranges[d].head.line;
e={anchor:q(e,0),head:q(e+1,0)};c.push(e);b.push(a.getRange(e.anchor,e.head))}return{text:b,ranges:c}}function ag(a,b){a.setAttribute("autocorrect","off");a.setAttribute("autocapitalize","off");a.setAttribute("spellcheck",!!b)}function bg(){var a=u("textarea",null,null,"position: absolute; bottom: -1em; padding: 0; width: 1px; height: 1em; outline: none"),b=u("div",[a],null,"overflow: hidden; position: relative; width: 3px; height: 0px;");T?a.style.width="1000px":a.setAttribute("wrap","off");Zb&&
(a.style.border="1px solid black");ag(a);return b}function Vd(a,b,c,d,e){function f(d){var f=e?Wg(a.cm,k,b,c):Md(k,b,c);if(null==f){if(d=!d)d=b.line+c,d<a.first||d>=a.first+a.size?d=!1:(b=new q(d,b.ch,b.sticky),d=k=t(a,d));if(d)b=Nd(e,a.cm,k,b.line,c);else return!1}else b=f;return!0}var g=b,h=c,k=t(a,b.line);if("char"==d)f();else if("column"==d)f(!0);else if("word"==d||"group"==d){var l=null;d="group"==d;for(var m=a.cm&&a.cm.getHelper(b,"wordChars"),p=!0;!(0>c)||f(!p);p=!1){var n=k.text.charAt(b.ch)||
"\n";n=ic(n,m)?"w":d&&"\n"==n?"n":!d||/\s/.test(n)?null:"p";!d||p||n||(n="s");if(l&&l!=n){0>c&&(c=1,f(),b.sticky="after");break}n&&(l=n);if(0<c&&!f(!p))break}}h=Kd(a,b,g,h,!0);Vc(g,h)&&(h.hitSide=!0);return h}function cg(a,b,c,d){var e=a.doc,f=b.left;if("page"==d){var g=Math.max(Math.min(a.display.wrapper.clientHeight,window.innerHeight||document.documentElement.clientHeight)-.5*Ra(a.display),3);g=(0<c?b.bottom:b.top)+c*g}else"line"==d&&(g=0<c?b.bottom+3:b.top-3);for(;;){b=rd(a,f,g);if(!b.outside)break;
if(0>c?0>=g:g>=e.height){b.hitSide=!0;break}g+=5*c}return b}function dg(a,b){var c=ld(a,b.line);if(!c||c.hidden)return null;var d=t(a.doc,b.line);c=Be(c,d,b.line);a=xa(d,a.doc.direction);d="left";a&&(d=vb(a,b.ch)%2?"right":"left");b=Ce(c.map,b.ch,d);b.offset="right"==b.collapse?b.end:b.start;return b}function lh(a){for(;a;a=a.parentNode)if(/CodeMirror-gutter-wrapper/.test(a.className))return!0;return!1}function qb(a,b){b&&(a.bad=!0);return a}function mh(a,b,c,d,e){function f(a){return function(b){return b.id==
...
0;this.cantEdit=!1;this.cleanGeneration=1;this.modeFrontier=this.highlightFrontier=c;c=q(c,0);this.sel=za(c);this.history=new Bc(null);this.id=++sh;this.modeOption=b;this.lineSep=d;this.direction="rtl"==e?"rtl":"ltr";this.extend=!1;"string"==typeof a&&(a=this.splitLines(a));Gd(this,{from:c,to:c,text:a});S(this,za(c),va)};aa.prototype=Xd(Pb.prototype,{constructor:aa,iter:function(a,b,c){c?this.iterN(a-this.first,b-a,c):this.iterN(this.first,this.first+this.size,a)},insert:function(a,b){for(var c=0,
d=0;d<b.length;++d)c+=b[d].height;this.insertInner(a-this.first,b,c)},remove:function(a,b){this.removeInner(a-this.first,b)},getValue:function(a){var b=Tc(this,this.first,this.first+this.size);return!1===a?b:b.join(a||this.lineSeparator())},setValue:O(function(a){var b=q(this.first,0),c=this.first+this.size-1;kb(this,{from:b,to:q(c,t(this,c).text.length),text:this.splitLines(a),origin:"setValue",full:!0},!0);this.cm&&Hb(this.cm,0,0);S(this,za(b),va)}),replaceRange:function(a,b,c,d){b=v(this,b);c=
...
1},clipPos:function(a){return v(this,a)},getCursor:function(a){var b=this.sel.primary();return null==a||"head"==a?b.head:"anchor"==a?b.anchor:"end"==a||"to"==a||!1===a?b.to():b.from()},listSelections:function(){return this.sel.ranges},somethingSelected:function(){return this.sel.somethingSelected()},setCursor:O(function(a,b,c){a=v(this,"number"==typeof a?q(a,b||0):a);S(this,za(a,null),c)}),setSelection:O(function(a,b,c){var d=v(this,a);a=v(this,b||a);S(this,za(d,a),c)}),extendSelection:O(function(a,
b,c){Dc(this,v(this,a),b&&v(this,b),c)}),extendSelections:O(function(a,b){nf(this,$d(this,a),b)}),extendSelectionsBy:O(function(a,b){a=hc(this.sel.ranges,a);nf(this,$d(this,a),b)}),setSelections:O(function(a,b,c){if(a.length){for(var d=[],e=0;e<a.length;e++)d[e]=new A(v(this,a[e].anchor),v(this,a[e].head));null==b&&(b=Math.min(a.length-1,this.sel.primIndex));S(this,pa(d,b),c)}}),addSelection:O(function(a,b,c){var d=this.sel.ranges.slice(0);d.push(new A(v(this,a),v(this,b||a)));S(this,pa(d,d.length-
...
handle:a,text:a.text,gutterMarkers:a.gutterMarkers,textClass:a.textClass,bgClass:a.bgClass,wrapClass:a.wrapClass,widgets:a.widgets}},addLineClass:O(function(a,b,c){return Nb(this,a,"gutter"==b?"gutter":"class",function(a){var d="text"==b?"textClass":"background"==b?"bgClass":"gutter"==b?"gutterClass":"wrapClass";if(a[d]){if(z(c).test(a[d]))return!1;a[d]+=" "+c}else a[d]=c;return!0})}),removeLineClass:O(function(a,b,c){return Nb(this,a,"gutter"==b?"gutter":"class",function(a){var d="text"==b?"textClass":
"background"==b?"bgClass":"gutter"==b?"gutterClass":"wrapClass",f=a[d];if(f)if(null==c)a[d]=null;else{var g=f.match(z(c));if(!g)return!1;var h=g.index+g[0].length;a[d]=f.slice(0,g.index)+(g.index&&h!=f.length?" ":"")+f.slice(h)||null}else return!1;return!0})}),addLineWidget:O(function(a,b,c){return Og(this,a,b,c)}),removeLineWidget:function(a){a.clear()},markText:function(a,b,c){return mb(this,v(this,a),v(this,b),c,c&&c.type||"range")},setBookmark:function(a,b){b={replacedWith:b&&(null==b.nodeType?
...
e=d.cm,f=d.div=a.lineDiv;ag(f,e.options.spellcheck);w(f,"paste",function(a){M(e,a)||Zf(a,e)||11>=F&&setTimeout(N(e,function(){return c.updateFromDOM()}),20)});w(f,"compositionstart",function(a){c.composing={data:a.data,done:!1}});w(f,"compositionupdate",function(a){c.composing||(c.composing={data:a.data,done:!1})});w(f,"compositionend",function(a){c.composing&&(a.data!=c.composing.data&&c.readFromDOMSoon(),c.composing.done=!0)});w(f,"touchstart",function(){return d.forceCompositionEnd()});w(f,"input",
...
function(a){var b=this.cm.display;E(b.cursorDiv,a.cursors);E(b.selectionDiv,a.selection);null!=a.teTop&&(this.wrapper.style.top=a.teTop+"px",this.wrapper.style.left=a.teLeft+"px")};L.prototype.reset=function(a){if(!this.contextMenuPending&&!this.composing){var b=this.cm;b.somethingSelected()?(this.prevInput="",a=b.getSelection(),this.textarea.value=a,b.state.focused&&ac(this.textarea),B&&9<=F&&(this.hasSelection=a)):a||(this.prevInput=this.textarea.value="",B&&9<=F&&(this.hasSelection=null))}};L.prototype.getField=
function(){return this.textarea};L.prototype.supportsTouch=function(){return!1};L.prototype.focus=function(){if("nocursor"!=this.cm.options.readOnly&&(!sb||wa()!=this.textarea))try{this.textarea.focus()}catch(a){}};L.prototype.blur=function(){this.textarea.blur()};L.prototype.resetPosition=function(){this.wrapper.style.top=this.wrapper.style.left=0};L.prototype.receivedFocus=function(){this.slowPoll()};L.prototype.slowPoll=function(){var a=this;this.pollingFast||this.polling.set(this.cm.options.pollInterval,
...
a.composing.range=b.markText(a.composing.start,b.getCursor("to"),{className:"CodeMirror-composing"}))});return!0};L.prototype.ensurePolled=function(){this.pollingFast&&this.poll()&&(this.pollingFast=!1)};L.prototype.onKeyPress=function(){B&&9<=F&&(this.hasSelection=null);this.fastPoll()};L.prototype.onContextMenu=function(a){function b(){if(null!=g.selectionStart){var a=e.somethingSelected(),b="\u200b"+(a?g.value:"");g.value="\u21da";g.value=b;d.prevInput=a?"":"\u200b";g.selectionStart=1;g.selectionEnd=
...
g=d.textarea,h=Ta(e,a),k=f.scroller.scrollTop;if(h&&!oa){e.options.resetSelectionOnContextMenu&&-1==e.doc.sel.contains(h)&&N(e,S)(e.doc,za(h),va);var l=g.style.cssText,m=d.wrapper.style.cssText;d.wrapper.style.cssText="position: absolute";h=d.wrapper.getBoundingClientRect();g.style.cssText="position: absolute; width: 30px; height: 30px;\n      top: "+(a.clientY-h.top-5)+"px; left: "+(a.clientX-h.left-5)+"px;\n      z-index: 1000; background: "+(B?"rgba(255, 255, 255, .05)":"transparent")+";\n      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);";
if(T)var p=window.scrollY;f.input.focus();T&&window.scrollTo(null,p);f.input.reset();e.somethingSelected()||(g.value=d.prevInput=" ");d.contextMenuPending=!0;f.selForContextMenu=e.doc.sel;clearTimeout(f.detectingSelectAll);B&&9<=F&&b();if(Qd){xb(a);var n=function(){ea(window,"mouseup",n);setTimeout(c,20)};w(window,"mouseup",n)}else setTimeout(c,50)}};L.prototype.readOnlyChanged=function(a){a||this.reset();this.textarea.disabled="nocursor"==a};L.prototype.setUneditable=function(){};L.prototype.needsContentAttribute=
...
b){var d=[];if(!c.hasOwnProperty(b))return d;var e=c[b];a=this.getModeAt(a);if("string"==typeof a[b])e[a[b]]&&d.push(e[a[b]]);else if(a[b])for(var h=0;h<a[b].length;h++){var k=e[a[b][h]];k&&d.push(k)}else a.helperType&&e[a.helperType]?d.push(e[a.helperType]):e[a.name]&&d.push(e[a.name]);for(b=0;b<e._global.length;b++)h=e._global[b],h.pred(a,this)&&-1==P(d,h.val)&&d.push(h.val);return d},getStateAfter:function(a,b){var c=this.doc;a=Math.max(c.first,Math.min(null==a?c.first+c.size-1:a,c.first+c.size-
...
0>P(th,fc)&&(G.prototype[fc]=function(a){return function(){return a.apply(this.doc,arguments)}}(aa.prototype[fc]));bb(aa);G.inputStyles={textarea:L,contenteditable:D};G.defineMode=function(a){G.defaults.mode||"null"==a||(G.defaults.mode=a);pg.apply(this,arguments)};G.defineMIME=function(a,b){cb[a]=b};G.defineMode("null",function(){return{token:function(a){return a.skipToEnd()}}});G.defineMIME("text/plain","null");G.defineExtension=function(a,b){G.prototype[a]=b};G.defineDocExtension=function(a,b){aa.prototype[a]=
...
Ea;a.scrollbarModel=Ye;a.Pos=q;a.cmpPos=x;a.modes=cd;a.mimeModes=cb;a.resolveMode=oc;a.getMode=dd;a.modeExtensions=db;a.extendMode=qg;a.copyState=Na;a.startState=je;a.innerMode=ed;a.commands=Tb;a.keyMap=Sb;a.keyName=Jf;a.isModifierKey=Gf;a.lookupKey=nb;a.normalizeKeyMap=Vg;a.StringStream=K;a.SharedTextMarker=Rb;a.TextMarker=Fa;a.LineWidget=Qb;a.e_preventDefault=Y;a.e_stopPropagation=he;a.e_stop=xb;a.addClass=Ha;a.contains=ka;a.rmClass=Ua;a.keyNames=Ga})(G);G.version="5.35.0";return G});
...
(function(d){"object"==typeof exports&&"object"==typeof module?d(require("../../lib/codemirror")):"function"==typeof define&&define.amd?define(["../../lib/codemirror"],d):d(CodeMirror)})(function(d){function q(b,a){return"pairs"==a&&"string"==typeof b?b:"object"==typeof b&&null!=b[a]?b[a]:w[a]}function x(b){for(var a=0;a<b.length;a++){var c=b.charAt(a),d="'"+c+"'";l[d]||(l[d]=A(c))}}function A(b){return function(a){return B(a,b)}}function t(b){var a=b.state.closeBrackets;return!a||a.override?a:b.getModeAt(b.getCursor()).closeBrackets||
a}function B(b,a){var c=t(b);if(!c||b.getOption("disableInput"))return d.Pass;var g=q(c,"pairs"),e=g.indexOf(a);if(-1==e)return d.Pass;c=q(c,"triples");for(var n=g.charAt(e+1)==a,y=b.listSelections(),l=0==e%2,m,u=0;u<y.length;u++){var r=y[u],f=r.head;var k=b.getRange(f,h(f.line,f.ch+1));if(l&&!r.empty())k="surround";else if(!n&&l||k!=a)if(n&&1<f.ch&&0<=c.indexOf(a)&&b.getRange(h(f.line,f.ch-2),f)==a+a){if(2<f.ch&&/\bstring/.test(b.getTokenTypeAt(h(f.line,f.ch-2))))return d.Pass;k="addFour"}else if(n){r=
0==f.ch?" ":b.getRange(h(f.line,f.ch-1),f);if(d.isWordChar(k)||r==a||d.isWordChar(r))return d.Pass;k="both"}else if(l&&(b.getLine(f.line).length==f.ch||C(k,g)||/\s/.test(k)))k="both";else return d.Pass;else k=n&&D(b,f)?"both":0<=c.indexOf(a)&&b.getRange(f,h(f.line,f.ch+3))==a+a+a?"skipThree":"skip";if(!m)m=k;else if(m!=k)return d.Pass}var p=e%2?g.charAt(e-1):a,v=e%2?a:g.charAt(e+1);b.operation(function(){if("skip"==m)b.execCommand("goCharRight");else if("skipThree"==m)for(var a=0;3>a;a++)b.execCommand("goCharRight");
else if("surround"==m){var c=b.getSelections();for(a=0;a<c.length;a++)c[a]=p+c[a]+v;b.replaceSelections(c,"around");c=b.listSelections().slice();for(a=0;a<c.length;a++){var f=c,g=a;var e=c[a];var n=0<d.cmpPos(e.anchor,e.head);e={anchor:new h(e.anchor.line,e.anchor.ch+(n?-1:1)),head:new h(e.head.line,e.head.ch+(n?1:-1))};f[g]=e}b.setSelections(c)}else"both"==m?(b.replaceSelection(p+v,null),b.triggerElectric(p+v),b.execCommand("goCharLeft")):"addFour"==m&&(b.replaceSelection(p+p+p+p,"before"),b.execCommand("goCharRight"))})}
function C(b,a){b=a.lastIndexOf(b);return-1<b&&1==b%2}function z(b,a){b=b.getRange(h(a.line,a.ch-1),h(a.line,a.ch+1));return 2==b.length?b:null}function D(b,a){var c=b.getTokenAt(h(a.line,a.ch+1));return/\bstring/.test(c.type)&&c.start==a.ch&&(0==a.ch||!/\bstring/.test(b.getTokenTypeAt(a)))}var w={pairs:"()[]{}''\"\"",triples:"",explode:"[]{}"},h=d.Pos;d.defineOption("autoCloseBrackets",!1,function(b,a,c){c&&c!=d.Init&&(b.removeKeyMap(l),b.state.closeBrackets=null);a&&(x(q(a,"pairs")),b.state.closeBrackets=
a,b.addKeyMap(l))});var l={Backspace:function(b){var a=t(b);if(!a||b.getOption("disableInput"))return d.Pass;var c=q(a,"pairs");a=b.listSelections();for(var g=0;g<a.length;g++){if(!a[g].empty())return d.Pass;var e=z(b,a[g].head);if(!e||0!=c.indexOf(e)%2)return d.Pass}for(g=a.length-1;0<=g;g--)c=a[g].head,b.replaceRange("",h(c.line,c.ch-1),h(c.line,c.ch+1),"+delete")},Enter:function(b){var a=t(b);a=a&&q(a,"explode");if(!a||b.getOption("disableInput"))return d.Pass;for(var c=b.listSelections(),g=0;g<
c.length;g++){if(!c[g].empty())return d.Pass;var e=z(b,c[g].head);if(!e||0!=a.indexOf(e)%2)return d.Pass}b.operation(function(){var a=b.lineSeparator()||"\n";b.replaceSelection(a+a,null);b.execCommand("goCharLeft");c=b.listSelections();for(a=0;a<c.length;a++){var d=c[a].head.line;b.indentLine(d,null,!0);b.indentLine(d+1,null,!0)}})}};x(w.pairs+"`")});
