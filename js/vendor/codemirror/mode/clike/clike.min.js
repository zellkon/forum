...
c||"'"==c)return b.tokenize=l(c),b.tokenize(a,b);if(M.test(c))return g=c,null;if(N.test(c)){a.backUp(1);if(a.match(O))return"number";a.next()}if("/"==c){if(a.eat("*"))return b.tokenize=f,f(a,b);if(a.eat("/"))return a.skipToEnd(),"comment"}if(J.test(c)){for(;!a.match(/^\/[\/*]/,!1)&&a.eat(J););return"operator"}a.eatWhile(K);if(L)for(;a.match(L);)a.eatWhile(K);a=a.current();return q(t,a)?(q(w,a)&&(g="newstatement"),q(A,a)&&(F=!0),"keyword"):q(x,a)?"type":q(z,a)?(q(w,a)&&(g="newstatement"),"builtin"):
q(B,a)?"atom":"variable"}function l(a){return function(b,c){for(var d=!1,e,k=!1;null!=(e=b.next());){if(e==a&&!d){k=!0;break}d=!d&&"\\"==e}if(k||!d&&!D)c.tokenize=null;return"string"}}function f(a,b){for(var c=!1,d;d=a.next();){if("/"==d&&c){b.tokenize=null;break}c="*"==d}return"comment"}function m(a,c){b.typeFirstDefinitions&&a.eol()&&I(c.context)&&(c.typeAtEndOfLine=H(a,c,a.pos))}var h=a.indentUnit,n=b.statementIndentUnit||h,r=b.dontAlignCalls,t=b.keywords||{},x=b.types||{},z=b.builtin||{},w=b.blockKeywords||
{},A=b.defKeywords||{},B=b.atoms||{},u=b.hooks||{},D=b.multiLineStrings,E=!1!==b.indentStatements,L=b.namespaceSeparator,M=b.isPunctuationChar||/[\[\]{}\(\),;:\.]/,N=b.numberStart||/[\d\.]/,O=b.number||/^(?:0x[a-f\d]+|0b[01]+|(?:\d+\.?\d*|\.\d+)(?:e[-+]?\d+)?)(u|ll?|l|f)?/i,J=b.isOperatorChar||/[+\-*&%=<>!?|\/]/,K=b.isIdentifierChar||/[\w\$_\xa1-\uffff]/,g,F;return{startState:function(a){return{tokenize:null,context:new C((a||0)-h,0,"top",null,!1),indented:0,startOfLine:!0,prevToken:null}},token:function(a,
d){var e=d.context;a.sol()&&(null==e.align&&(e.align=!1),d.indented=a.indentation(),d.startOfLine=!0);if(a.eatSpace())return m(a,d),null;g=F=null;var k=(d.tokenize||c)(a,d);if("comment"==k||"meta"==k)return k;null==e.align&&(e.align=!0);if(";"==g||":"==g||","==g&&a.match(/^\s*(?:\/\/.*)?$/,!1))for(;"statement"==d.context.type;)v(d);else if("{"==g)y(d,a.column(),"}");else if("["==g)y(d,a.column(),"]");else if("("==g)y(d,a.column(),")");else if("}"==g){for(;"statement"==e.type;)e=v(d);for("}"==e.type&&
(e=v(d));"statement"==e.type;)e=v(d)}else g==e.type?v(d):E&&(("}"==e.type||"top"==e.type)&&";"!=g||"statement"==e.type&&"newstatement"==g)&&y(d,a.column(),"statement",a.current());"variable"==k&&("def"==d.prevToken||b.typeFirstDefinitions&&H(a,d,a.start)&&I(d.context)&&a.match(/^\s*\(/,!1))&&(k="def");u.token&&(e=u.token(a,d,k),void 0!==e&&(k=e));"def"==k&&!1===b.styleDefs&&(k="variable");d.startOfLine=!1;d.prevToken=F?"def":k||g;m(a,d);return k},indent:function(a,d){if(a.tokenize!=c&&null!=a.tokenize||
a.typeAtEndOfLine)return p.Pass;var e=a.context,f=d&&d.charAt(0);"statement"==e.type&&"}"==f&&(e=e.prev);if(b.dontIndentStatements)for(;"statement"==e.type&&b.dontIndentStatements.test(e.info);)e=e.prev;if(u.indent&&(a=u.indent(a,e,d),"number"==typeof a))return a;a=f==e.type;var g=e.prev&&"switch"==e.prev.info;if(b.allmanIndentation&&/[{(]/.test(f)){for(;"top"!=e.type&&"}"!=e.type;)e=e.prev;return e.indented}return"statement"==e.type?e.indented+("{"==f?0:n):!e.align||r&&")"==e.type?")"!=e.type||a?
e.indented+(a?0:h)+(a||!g||/^(?:case|default)\b/.test(d)?0:h):e.indented+n:e.column+(a?0:1)},electricInput:!1!==b.indentSwitch?/^\s*(?:case .*?:|default:|\{\}?|\})$/:/^\s*[{}]$/,blockCommentStart:"/*",blockCommentEnd:"*/",blockCommentContinue:" * ",lineComment:"//",fold:"brace"}});l(["text/x-csrc","text/x-c","text/x-chdr"],{name:"clike",keywords:c("auto if break case register continue return default do sizeof static else struct switch extern typedef union for goto while enum const volatile"),types:c("int long char short double float unsigned signed void size_t ptrdiff_t bool _Complex _Bool float_t double_t intptr_t intmax_t int8_t int16_t int32_t int64_t uintptr_t uintmax_t uint8_t uint16_t uint32_t uint64_t"),
...
indentStatements:!1,multiLineStrings:!0,number:/^(?:0x[a-f\d_]+|0b[01_]+|(?:[\d_]+(\.\d+)?|\.\d+)(?:e[-+]?[\d_]+)?)(u|ll?|l|f)?/i,blockKeywords:c("catch class do else finally for if where try while enum"),defKeywords:c("class val var object interface fun"),atoms:c("true false null this"),hooks:{'"':function(a,b){b.tokenize=E(a.match('""'));return b.tokenize(a,b)}},modeProps:{closeBrackets:{triples:'"'}}});l(["x-shader/x-vertex","x-shader/x-fragment"],{name:"clike",keywords:c("sampler1D sampler2D sampler3D samplerCube sampler1DShadow sampler2DShadow const attribute uniform varying break continue discard return for while do if else struct in out inout"),
