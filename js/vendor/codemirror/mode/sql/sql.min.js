...
b=c.current().toLowerCase();return q.hasOwnProperty(b)&&(c.match(/^( )+'[^']*'/)||c.match(/^( )+"[^"]*"/))?"number":r.hasOwnProperty(b)?"atom":t.hasOwnProperty(b)?"builtin":u.hasOwnProperty(b)?"keyword":v.hasOwnProperty(b)?"string-2":null}}else return"keyword"}function a(a){return function(c,f){for(var b=!1,d;null!=(d=c.next());){if(d==a&&!b){f.tokenize=k;break}b=w&&!b&&"\\"==d}return"string"}}function f(a){return function(c,d){var b=c.match(/^.*?(\/\*|\*\/)/);b?d.tokenize="/*"==b[1]?f(a+1):1<a?f(a-
1):k:c.skipToEnd();return"comment"}}function p(a,b,f){b.context={prev:b.context,indent:a.indentation(),col:a.column(),type:f}}var v=g.client||{},r=g.atoms||{"false":!0,"true":!0,"null":!0},t=g.builtin||{},u=g.keywords||{},n=g.operatorChars||/^[*+\-%<>!=&|~^]/,h=g.support||{},m=g.hooks||{},q=g.dateSQL||{date:!0,time:!0,timestamp:!0},w=!1!==g.backslashStringEscapes;return{startState:function(){return{tokenize:k,context:null}},token:function(a,b){a.sol()&&b.context&&null==b.context.align&&(b.context.align=
!1);if(b.tokenize==k&&a.eatSpace())return null;var c=b.tokenize(a,b);if("comment"==c)return c;b.context&&null==b.context.align&&(b.context.align=!0);var f=a.current();"("==f?p(a,b,")"):"["==f?p(a,b,"]"):b.context&&b.context.type==f&&(b.indent=b.context.indent,b.context=b.context.prev);return c},indent:function(a,b){a=a.context;if(!a)return e.Pass;b=b.charAt(0)==a.type;return a.align?a.col+(b?0:1):a.indent+(b?0:l.indentUnit)},blockCommentStart:"/*",blockCommentEnd:"*/",lineComment:h.commentSlashSlash?
"//":h.commentHash?"#":"--"}});(function(){function l(a){for(var f;null!=(f=a.next());)if("`"==f&&!a.eat("`"))return"variable-2";a.backUp(a.current().length-1);return a.eatWhile(/\w/)?"variable-2":null}function g(a){a.eat("@")&&(a.match(/^session\./),a.match(/^local\./),a.match(/^global\./));return a.eat("'")?(a.match(/^.*'/),"variable-2"):a.eat('"')?(a.match(/^.*"/),"variable-2"):a.eat("`")?(a.match(/^.*`/),"variable-2"):a.match(/^[0-9a-zA-Z$\._]+/)?"variable-2":null}function k(a){return a.eat("N")?
"atom":a.match(/^[a-zA-Z.#!?]/)?"variable-2":null}function a(a){var e={};a=a.split(" ");for(var f=0;f<a.length;++f)e[a[f]]=!0;return e}e.defineMIME("text/x-sql",{name:"sql",keywords:a("alter and as asc between by count create delete desc distinct drop from group having in insert into is join like not on or order select set table union update values where limit begin"),builtin:a("bool boolean bit blob enum long longblob longtext medium mediumblob mediumint mediumtext time timestamp tinyblob tinyint tinytext text bigint int int1 int2 int3 int4 int8 integer float float4 float8 double char varbinary varchar varcharacter precision real date datetime year unsigned signed decimal numeric"),
